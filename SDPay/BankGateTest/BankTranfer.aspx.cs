...
namespace BankGateTest
{
    public partial class BankTranfer : System.Web.UI.Page
    {
        ...
        public string url = "";
        string urlService = "https://bankgate.cd99pay.info/bankin/order.ashx";


        string urlgetbank = "https://bankgate.28pay.info/bankin/info.ashx";
        ...
        private void Order()
        {
            ...
            var requestContent = new OrderRequest()
            {
                ...
                RefCode = DateTime.Now.ToString("paytestMMddHHmmss"),
                BankCode = "MOMO",
                PartnerCode = partnerCode,
            };
            var signature = Encrypts.MD5(partnerCode + "MOMO" + requestContent.Amount + requestContent.RefCode + requestContent.CallbackUrl + partnerKey);
