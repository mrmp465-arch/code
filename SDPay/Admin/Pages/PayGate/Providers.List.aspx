    ...
    <section class="content">
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
                ...
                <li class="<% if (Request["Type"] == "15")
                    {%>active <% }%>"><a href="#mua-the" data-toggle="tab">Mua mã thẻ</a></li>
                <li class="<% if (Request["Type"] == "5")
                    {%>active <% }%>" style="display:none"><a href="#topup-mobile" data-toggle="tab">Topup TK Mobile</a></li>
                <li class="<% if (Request["Type"] == "13")
                    {%>active <% }%>"><a href="#ngan-hang" data-toggle="tab">Nạp bank</a></li>
                <li class="<% if (Request["Type"] == "18")
                    {%>active <% }%>"><a href="#bankcash" data-toggle="tab">Rút bank</a></li>
            </ul>
            <div class="tab-content no-padding">
                                ...
                                <asp:Repeater ID="rptList1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtQuota" placeholder="Nhập giới hạn doanh số" runat="server" CssClass="form-control txtQuota" Text='<%# Convert.ToInt64(DataBinder.Eval(Container.DataItem, "Quota").ToString()) / 1000000 %>'></asp:TextBox>
                                            </td>
                ...
                <div class="chart tab-pane <% if (Request["Type"] == "15")
                    {%>active <% }%>"
                    id="mua-the">
                    <div class="box-body no-padding">
                        <div style="height: 20px; clear: both;"></div>
                ...
                <div class="chart tab-pane <% if (Request["Type"] == "5")
                    {%>active <% }%>"
                    id="topup-mobile">
                    <div class="box-body no-padding">
                        <div style="height: 20px; clear: both;"></div>
                    ...
                    <div class="box-footer">
                        <asp:Button ID="Button10" runat="server" Text="Thêm mới" CssClass="btn btn-info " OnClick="btAdd_Click6"></asp:Button>
                        <asp:Button ID="Button11" runat="server" Text="Update" CssClass="btn btn-info pull-right " OnClick="btApply_Click6"></asp:Button>
                    </div>
                </div>
