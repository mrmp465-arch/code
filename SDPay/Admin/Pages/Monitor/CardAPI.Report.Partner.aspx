<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="CardAPI.Report.Partner.aspx.cs" Inherits="Pages_Monitor_CardAPI_Report_Partner" %>
                        ...
                        <table class="table table-striped" id="TableResponsive" style="margin-top: 20px; clear: both;">
                            <thead>
                                <tr>
                                    ...
                                    <th style=""><span style="padding-left: 30%;">TotalAmount</span></th>
                                    <th style="text-align: center;">%</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr class="trId<%#Eval("PartnerId") %> <%#Eval("TrClass") %> tr<%#Eval("Row") %> closes" data-id="<%#Eval("PartnerCode") %>">
                                            <td style="padding: 15px 0 15px 0; width: 0 !important;"></td>
                                            <td class="td0"><%#Eval("STT") %></td>
                                            <td style="text-align: center;" class="td1 clicktd"><%#Eval("PartnerCode") %></td>
                                            ...
                                            <td class="clicktd"><span style="padding-left: 30%;"><a href="<%#PartnerDiscountUrl(Eval("PartnerID").ToString(),Eval("PartnerCode").ToString())%>"><%#Convert.ToInt64(Eval("TotalAmount")).ToString("N0").Replace(",", ".") %></a></span></td>
