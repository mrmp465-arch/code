                                            ...
                                            <asp:Repeater ID="rptList" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtOrderNo" placeholder="<%= Resources.Pay.Number%> " Width="50" runat="server" CssClass="form-control txtOrderNo" Text='<%# DataBinder.Eval(Container.DataItem, "Number") %>'></asp:TextBox>
                                                        </td>
                                                        <td>
