    ...
    protected void btnCashForm4_Click(object sender, EventArgs e)
    {
        ...
        if (resObj != null)
        {
            ...
            if (resObj.ResponseCode == (int)ResponseCode.TransactionSuccessful)
            {
                ...
                TelegramClient.SendTeleV2("-5490965546", "Chuyển tiền bank " + drpBankCode.SelectedValue + " | " + txtBankId.Text + " | " + txtAmountForm4.Text + " |" + drpBankCodeForm4.SelectedValue + " | " + txtBankIdForm4.Text +" từ user " + AppUtils.UserName );
                _userLog.Add();
            }
