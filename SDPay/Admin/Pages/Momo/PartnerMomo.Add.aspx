<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/Layout.master" CodeFile="PartnerMomo.Add.aspx.cs" Inherits="Pages_Momo_PartnerMomo_Add" %>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-tools" style="margin-top: 10px;">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-5">
                                <div class="form-group">
                                    <label for="txtName">Chọn đối tác *</label>
                        ...
                        <div class="box-tools" style="margin-top: 10px;">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-2">
                                <div class="input-group">
                                    <span class="input-group-addon" style="padding: 5px;">Số điện thoại</span>
                                    ...
                                    <asp:Repeater ID="rptList" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%#Eval("Id") %></td>
                                                <td><a href="<%=Constant.ADMIN_PATH %><%=Resources.Url.MomoAccountEdit %>?id=<%#Eval("Id") %>"><%#Eval("MomoName") %></a></td>
                                                <td><%#Eval("MomoId") %></td>

                                                <td><%#Convert.ToInt32(Eval("BalanceDayIn")).ToString("N0").Replace(",", ".") %></td>
                                                <td><%#Convert.ToInt32(Eval("BalanceMonthIn")).ToString("N0").Replace(",", ".") %></td>
                                                <td><%#Convert.ToInt32(Eval("BalanceDayOut")).ToString("N0").Replace(",", ".") %></td>
                                                <td><%#Convert.ToInt32(Eval("BalanceMonthOut")).ToString("N0").Replace(",", ".") %></td>
                                                <td><%#Convert.ToInt32(Eval("BalanceTotal")).ToString("N0").Replace(",", ".") %></td>
                                                <td><%#Eval("Type") %></td>
