    ...
    <asp:Panel ID="PanelContent" runat="server">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <% if (AppUtils.IsPartner || AppUtils.IsTopup)
                    { %>
                ...
                <div class="col-lg-3 col-xs-6">
                    <!-- small box -->
                    <div class="small-box bg-yellow tex">
                        <div class="inner" >

                            <h3><%= Resources.Pay.Sevice%></h3>
                            <p><%= service1 %></p>
                            <p><%= service2 %></p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="pages/paygate/partners.list.aspx" class="small-box-footer"><%= Resources.Pay.ViewMore%><i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red tex">
                        ...
                        <a href="pages/paygate/providers.list.aspx" class="small-box-footer"><%= Resources.Pay.ViewMore%> <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <% } %>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                                <div class="input-group">
                                                    ...
                                                    <asp:DropDownList ID="drpGroup" runat="server" CssClass="form-control select2">
                                                        <asp:ListItem Value="">Provider:</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <% 
                                                        ...
                                                        <asp:Repeater ID="rptListBank2" runat="server">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td><%#Convert.ToInt64(Eval("TotalAmountSuccess")).ToString("N0").Replace(".", ",") %></td>
                                                                    <td><%#Convert.ToInt64(Eval("TotalFee")).ToString("N0").Replace(".", ",") %></td>
                                                                    <td><%#Eval("TotalTransSuccess")%>/<%#Eval("TotalTrans")%>  (<%#AmountToPercent(Eval("TotalTransSuccess"),Eval("TotalTrans")) %>%)</td>
                                                                    <%-- <td></td>
                                                                         <td><%#GetPerCent(Eval("TotalTrans"),Eval("TotalTransSuccess")) %> %</td>--%>

                                                                    <td><%#Convert.ToInt64(Eval("TotalAmountSuccessCash")).ToString("N0").Replace(".", ",") %></td>
                                                                    <td><%#Convert.ToInt64(Eval("TotalFeeCash")).ToString("N0").Replace(".", ",") %></td>
                                                                    <td><%#Eval("TotalTransSuccessCash")%>/<%#Eval("TotalTransCash")%> (<%#AmountToPercent(Eval("TotalTransSuccessCash"),Eval("TotalTransCash")) %>%)</td>
