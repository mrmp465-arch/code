...
{
    public partial class NapBank : System.Web.UI.Page
    {
        JavaScriptSerializer serializer = new JavaScriptSerializer();
        public string url = "";
        string urlService = "https://bankgate.28pay.info/bankin/order.ashx";
        ...
        private void Order()
        {
            ...
            var requestContent = new OrderRequest()
            {
                ...
                CallbackUrl = "https://test.28pay.info/callback.ashx",
                RefCode = DateTime.Now.ToString("MMddHHmmss"),
                BankCode = ddlBanks.SelectedValue,
                PartnerCode = partnerCode,
            };
