...
namespace BankGateV2.Callback
{
    ...
    /// </summary>
    public class DrumBank : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var newclObj = serializer.Deserialize<MDrumBankLib.Callback>(callbackdata.ResponseContent);
            if(string.IsNullOrEmpty(newclObj.Note)|| newclObj.Note== "[COMMENT_INCORRECT_FORMAT]" || newclObj.Note == "[COMMENT_INCORRECT]")
            {
            ...
            try
            {
                //if(newclObj.Note.ToLower().Equals("bp7"))
                //{
                //    var partnercode = "bp7";
                //    var newclObjV3 = serializer.Deserialize<MDrumBankLib.CallbackV3>(callbackdata.ResponseContent);
                //    var callback = new MDrumV2Bank().CallbackV3(newclObjV3, partnercode);
                ...
                //else
                //{
                    var callback = new MDrumV2Bank().Callback(newclObj);
