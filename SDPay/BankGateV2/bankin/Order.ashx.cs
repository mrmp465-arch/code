    ...
    public class Order : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                NLogLogger.Info(new string[] { "VPGJsonService", "Request", jsonString, xpartnerCode });

                if (string.IsNullOrEmpty(xpartnerCode)  && request.PartnerCode!="fastpay" && request.PartnerCode != "paytest")
                {
