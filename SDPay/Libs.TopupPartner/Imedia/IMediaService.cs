...
namespace Libs.TopupPartner.Imedia
{
    public class IMediaService : IBuyCardHandler
    {

        protected string ServiceUrl = "http://127.0.0.1:1587/BuyCard.ashx";
        //protected string ServiceUrl = "http://149.28.130.246:1587/BuyCard.ashx";
        ...
        public APIResponse downloadSoftpin(string requestId, string provider, int amount, int quantity, string partnerCode, string providerCode, ref string providerResponse)
        {
            ...
            {
                TelegramNotify.SendNotify(-845553760, $"Tài khoản không đủ tiền !!!");
            }
