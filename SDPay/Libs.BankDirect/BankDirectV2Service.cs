    ...
    public class BankDirectV2Service : IServiceHandler
    {
        ...
        private APIResponse GetBanksV2(APITransaction transaction)
        {
            ...
            try
            {
                ...
                var service = systemDataConfig.GetKey(lstConfig, "Service");
                if (service == "247")
                {
                    providerCode = "24hbank";
                }
                if (service == "fast")
                {
                    providerCode = "fastpay";
                }
        ...
        private APIResponse Order(APITransaction transaction)
        {
            ...
            try
            {
                ...
                //if (result.ResponseCode != 1 || transaction.PartnerCode == "opvvv")
