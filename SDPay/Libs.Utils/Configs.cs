...
namespace Libs.Db
{
    public sealed class Configs
    {
        ...
        private string _VPGMOMOConnectionStrings;
        private string _VPGBankConnectionStrings;

        private string _VPGMOMOReportConnectionStrings;
        private string _VPGBankReportConnectionStrings;
        ...
        public static string VPGBankConnectionStrings
        {
            get
            {
                return instance._VPGBankConnectionStrings;
            }
        }
        public static string VPGMOMOConnectionStrings
        {
            get
            {
                return instance._VPGMOMOConnectionStrings;
            }
        }
        public static string VPGBankReportConnectionStrings
        {
            get
            {
                return instance._VPGBankReportConnectionStrings;
            }
        }
        public static string VPGMOMOReportConnectionStrings
        {
            get
            {
                return instance._VPGMOMOReportConnectionStrings;
            }
        }
        ...
        Configs()
        {
            ...
            _VPGMOMOConnectionStrings = GetConnectionString("VPGMOMOConnectionStrings");
            _VPGBankConnectionStrings = GetConnectionString("VPGBankConnectionStrings");
            _VPGMOMOReportConnectionStrings = GetConnectionString("VPGMOMOReportConnectionStrings");
            _VPGBankReportConnectionStrings = GetConnectionString("VPGBankReportConnectionStrings");
