...
namespace APIVinaPay
{
    internal class TopupApp
    {
        ...
        private string ServiceUrl = ConfigurationManager.AppSettings["ServiceUrl"] ?? "https://apicard.fspay.info/VPGJsonService.ashx";
        private string CallbackUrl = ConfigurationManager.AppSettings["CallbackUrl"] ?? "http://45.32.115.186:1596/CardCallback.ashx";
        private string CallbackUrlV2 = "http://139.180.184.160:1596/CardCallbackV2.ashx";
        private const string apiKey = "vdt50@";
        private const string username = "vdt50@gmail.com";
        private const int ClientID = 20;

        private const string _partnerCode = "cd99";
        private const string _partnerKey = "daee96339f77a3a9124a2dfbef9da4ed";
        ...
        public async Task<string> VinaPayTopupCallBack(string transactionId, string telco, string partnerCode, string providerCode, string serial, string pin, int amount)
        {
            ...
            try
            {
                ...
                NLogLogger.Info(new string[] { "BB2D", topup.TransactionId.ToString(), "BB2DRequest", serializer.Serialize(requestData), _partnerCode + serviceCode + commandCode + requestContent + _partnerKey });
