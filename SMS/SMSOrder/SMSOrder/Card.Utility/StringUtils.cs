...
namespace SMS.Utility
{
    public static class StringUtils
    {
        ...
        public static int GetCounSMS(string Content)
        {
            return ((int)Content.Length / 158) + 1;
        ...
        public static string ConvertToWord(string numberString)
        {
            var equivalentWord = "";
            char[] numberArray = numberString.ToCharArray();
            foreach (char c in numberArray)
            {
                // Here i am converting the char c into int and passing it to 
                // numberToWord method since it accepts int as param.
                // You can pass the char itself to the numbertoWord function and 
                // use it. For that u need to change the numberToWord method 
                // to accept the char and also case statements.
                equivalentWord = equivalentWord + "," + numberToWord(int.Parse(c.ToString()));
            }
        ...
        public static string InsertCommaNoStyle(object Money)
        {
        ...
        public static string ReplaceVietnameseChar2(string s)
        {
            if (s == null)
                return String.Empty;
            // replace specification character
