    ...
    l.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, e, c) {
            ...
            e = function (a, tag, index, lst_row) {
                var b = [];
                for (cellIdx = 0, d = a.length; cellIdx < d; cellIdx++) {
                    var countRowspan = 1;
                    ...
                    if (countRowspan == 0) {
                        ...
                        b.push($.isNumeric(a[cellIdx]) || a[cellIdx].match && a[cellIdx].match(/^-?[0-9\.\,]+$/) ?
                            '<' + tag + ' rowspan="' + countRowspan + '"  align="right" style="border:1px solid #848484; vertical-align: middle;text-align:right">' + a[cellIdx] + '</' + tag + '>' :
                        ...
                        b.push($.isNumeric(a[cellIdx]) || a[cellIdx].match && a[cellIdx].match(/^-?[0-9\.\,]+$/) ?
                            '<' + tag + ' align="right" style="border:1px solid #848484; vertical-align: middle; text-align:right">' + a[cellIdx] + '</' + tag + '>' :
