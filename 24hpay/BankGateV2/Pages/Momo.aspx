<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Momo.aspx.cs" Inherits="BankGateV2.Pages.Momo" %>
                        ...
                        <asp:Panel ID="pn_show_info" runat="server">
                            <div id="show_info" class="row" runat="server">
                                <div class="col-lg-5" style="padding-top: 1rem; text-align: center;">
                                    ...
                                    <!--<p class="mb-1 px-3 lngvi" style="color: #4e73df">Sử dụng app <strong>momo</strong> quét mã, và hãy chắc chắn rằng bạn điền <strong id="note_message"></strong> vào ô lời nhắn</p>-->
                                   <%-- <a class="btn btn-success" style="color: white" href="<%=LinkOpenApp %>" id="deeplink">Ấn để mở Momo</a>--%>
                                </div>
                                <div class="col-lg-7" style="padding-top: 1rem; text-align: center;">
                                    ...
                                    <div class="">
                                        <div class="form-group" style="text-align: left;">
                                            <div>
                                                <label>Số tài khoản MOMO nhận tiền</label>
                                ...
                                <div class="col-lg-12" style="padding-top: 1rem; text-align: center;">
                                      <span style="color: red;">
                                          Mỗi mã QRCode và nội dung chỉ được sử dụng 1 lần<br />
