                    ...
                    <div class="box-tools" style="margin-top: 10px;">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-1">
                            <asp:DropDownList ID="drpPartnerBankCode" runat="server" CssClass="form-control select2">
                                ...
                                <asp:ListItem Text="NAB" Value="NAB"></asp:ListItem>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:HyperLink NavigateUrl='<%#EditTranInUrl(Eval("Id").ToString()) %>' Visible='<%#   Eval("CommandCode").ToString() == "IN" && Eval("Comment").ToString() != "hoantien" %>' runat="server"> [Sửa Code] </asp:HyperLink>
                                                &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" OnCommand="SendTele_Command" CommandName="SendTele" CommandArgument='<%#Eval("Id")%>' Visible='<%# Eval("Status").ToString() == "1" && Eval("PartnerCode").ToString()=="sn" %>' OnClientClick="return confirm('Bạn có muốn thực hiện?')">[Send Tele] </asp:LinkButton>
                                                ...
                                                <asp:HyperLink
                                                    ID="lnbill"
                                                    CssClass="lightbox"
                                                    NavigateUrl='<%# "https://info.24happ.info/Pages/Detail2.aspx?orderNo=" + Eval("Id") %>'
                                                    runat="server"
