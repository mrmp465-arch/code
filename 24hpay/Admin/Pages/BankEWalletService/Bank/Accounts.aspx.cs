...
public partial class Pages_BankEWalletService_Bank_Accounts : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        var _Bank = new BankAccounts();
        var data = _Bank.GetList().OrderByDescending(x => x.BalanceTotal).OrderBy(a => GetBankOrder(a.Type)).ToList();
        ...
        try
        {
            ...
            if (Status.ToString() == "1")
            {
                ...
                if (Type.ToString().Equals("INOUT"))
                {
                    ...
                    {
                        if (int.Parse(Balance.ToString()) > 70000000)
                        {
                            return "bwarning";
                        }
                    }
    ...
    public int GetBankOrder(string type)
    {
        if (type == "IN")
        {
            return 1;
