...
public partial class Pages_BankEWalletService_InternalTransfer_ITAccounts2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        AppUtils.CheckRoles(Resources.Url.ITAccount2);

        if (!IsPostBack)
        {
            //if (!AppUtils.UserName.Equals("admin"))
            ...
            drpBankCode.DataTextField = "shortName";
            drpBankCode.DataValueField = "code";
            drpBankCode.DataBind();
            drpBankCode.Items.Insert(0, new ListItem("Chọn Bank:", ""));
            BindData();
        }
    }
    ...
    {
        var data = new ITBank().GetList().Where(x => x.Type == "PRIVATE");
