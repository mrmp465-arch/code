<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportDaily.aspx.cs" MasterPageFile="~/Layout/Layout.master" Inherits="Pages_BankEWalletService_InternalTransfer_ReportDaily" %>
    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
                ...
                <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.ITransaction %>">Lệnh gom</a></li>
                <li class="active"><a href="#revenue-chart" data-toggle="tab">Báo cáo</a></li>
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="rptList" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td></td>
                                                    <td><%#Eval("Time")%></td>
                                                    <td><%#Convert.ToInt32(Eval("TotalIn")) %></td>
                                                    <td><%#Convert.ToInt64(Eval("TotalAmountIn")).ToString("#,#").Replace(".", ",") %></td>
                                        ...
                                        <tr style="font-weight: bold">
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="lblTotalAmoutIn" runat="server" Text=""></asp:Label>
                                            </td>
