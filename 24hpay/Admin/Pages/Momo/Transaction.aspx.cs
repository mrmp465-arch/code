...
public partial class Pages_Momo_Transaction : System.Web.UI.Page
{
    ...
    private void GetList()
    {
        ...
        var lstdata = new MomoTransaction().GetList(top, id, drpPartner.SelectedValue, txtPartnerMomoId.Text, txMomoTransId.Text, txtMomoId.Text, drpType.SelectedValue, creatTime, status, cbByPass10k.Checked, txtRefCode.Text, txtComment.Text);
