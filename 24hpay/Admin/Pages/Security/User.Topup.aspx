<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/Layout.master" CodeFile="User.Topup.aspx.cs" Inherits="Pages_Security_User_Topup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>Tài Khoản
        <small><a href="<%=Constant.ADMIN_PATH %><%=Resources.Url.UsersList %>">Cộng tiền tài khoản</a>
        </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<%=Constant.ADMIN_PATH %>Default.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li class="active">Cộng tiền tài khoản</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Cộng tiền tài khoản : <%=UserName %></h3>
            </div>
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="txtName">Số tiền *</label>
                            <div class="row">
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtAmount" runat="server" CssClass="form-control" placeholder="Số tiền"></asp:TextBox>
                                </div>
            ...
            <div class="box-footer">
                <asp:Button ID="btAdd" runat="server" Text="Cộng tiền" CssClass="btn btn-info " OnClick="btAdd_Click"></asp:Button>
