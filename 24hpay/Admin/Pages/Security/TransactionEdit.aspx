                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group" style="display: none">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <asp:TextBox ID="txtRateIn" Text="0" runat="server" CssClass="form-control" placeholder="Nhập tỉ giá ví dụ 26500"></asp:TextBox>
                                        </div>
                               ...
                               <div class="form-group" style="display: none">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <asp:TextBox ID="txtRate" Text="0" runat="server" CssClass="form-control" placeholder="Nhập tỉ giá ví dụ 26600"></asp:TextBox>
                                        </div>
