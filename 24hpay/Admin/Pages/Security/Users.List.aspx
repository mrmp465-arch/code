                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2">
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control select2">
                                    ...
                                    <asp:ListItem Text="Merchant" Value="2"></asp:ListItem>
                        ...
                        <table class="table table-striped" id="TableResponsive">
                            <thead>
                                ...
                                <th>Đăng nhập lần cuối</th>--%>
                                    <%-- <th>Đăng nhập lần cuối</th>--%>
                                    <%--   <th>Nhóm</th>--%>
                                    <th>Chiết khấu (bank|bankouut)</th>
                                    <th>Hoa hồng (bank|bankout)</th>
                                    <th>Kích hoạt</th>
                                    <th>Tác vụ</th>
                                </tr>
                            </thead>
                                ...
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#GetUserType(Eval("IsAdmin").ToString(),Eval("IsPartner").ToString(),Eval("IsTopup").ToString())%></td>
                                            <%-- <td><%#Eval("LastestTime")%></td--%>

                                            <td><%#GetUserCk(Eval("UserName").ToString())%>
                                           
                                            </td>
                                            <td>
                                                <%#GetUserRw(Eval("UserName").ToString())%>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <asp:LinkButton ID="lnkDelete" CausesValidation="false" ToolTip="Hủy" CommandArgument='<%#Eval("UserID")%>' Visible='<%#Eval("F2a").ToString().Length>0%>'
                                                    CommandName="delete" OnClientClick="return confirm('Bạn chắc chắn muốn thực hiện?'); "
                                                    runat="server" OnCommand="Delete_Command">Reset bảo mật</asp:LinkButton>
