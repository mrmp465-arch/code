                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="font-size: 105%">
                                                ...
                                                <asp:HyperLink NavigateUrl='<%# FixtUrl(Eval("TransactionID").ToString()) %>' Visible='<%# Convert.ToInt32(Eval("Status")) == 0 
   && (
       Convert.ToInt64(Eval("Amount")) < MaxAmount 
       || RoleFixAdmin
   ) %>'
                                                    runat="server"> [Sửa đơn] </asp:HyperLink>
                                                <% } %>
