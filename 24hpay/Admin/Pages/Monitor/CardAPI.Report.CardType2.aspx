<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="CardAPI.Report.CardType2.aspx.cs" Inherits="Pages_Monitor_CardAPI_Report_CardType2" %>
    ...
    <section class="content">
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
                ...
                <% }%>
                <li class="active"><a href="#revenue-chart" data-toggle="tab">Tổng hợp thẻ</a></li>
            </ul>
                    ...
                    <div class="box-tools" style="margin-top: 10px;">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-5">
                            ...
                            <div class="input-group date-group" style="float: left; margin-right: 15px;">
                                ...
                                <asp:DropDownList ID="drpDay" runat="server" CssClass="input-group-addon" Visible="false"></asp:DropDownList>
                            </div>
                                ...
                                <table class="table table-striped" id="TableResponsive" style="margin-top: 20px; clear: both;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2">#</th>
                                            <th style="text-align: center;" colspan="<%=Partner.Count+1%>">Loại thẻ</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <%if (Data.Exists(x => x.Time == time && x.CardType == item))
                                                {%>
                                            <td><%=Data.FirstOrDefault(x => x.Time == time && x.CardType == item).TotalAmount.ToString("N0").Replace(",", ".")%> </td>
                                            <%}
                                            else
                                            {%>
                                           ...
                                           <td><%=Data.Where(x => x.Time == time ).Sum(a=>a.TotalAmount).ToString("N0").Replace(",", ".")%> </td>
                                        </tr>
                                        <%} %>
