...
namespace UnitTest
{
    ...
    public class BanksTest
    {
        ...
        public void GetBanksJson()
        {
            ...
            JavaScriptSerializer serializer = new JavaScriptSerializer();
            var requestContent = serializer.Serialize(new GetBankRequest() { BankType = "momov2",AccountName="test" });
            var signature = Encrypts.MD5(partnerCode + serviceCode + commandCode + requestContent + partnerKey);
            ...
            //var serviceResponse = CallbackJson(urlService, serializer.Serialize(requestData)).Result;
            //Console.WriteLine(serviceResponse);
        }
    ...
    public class TransctionBankRequest
    {
        public string BankType { get; set; }
        public string AccountName { get; set; }
        public string AppCode { get; set; }
