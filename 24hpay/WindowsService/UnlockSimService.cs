...
namespace WService
{
    ...
    public class UnlockSimService
    {
        ...
        public void StartProcessUnlockSim()
        {
            timer = new Timer()
            {
        ...
        void timer_Elapsed(object sender, ElapsedEventArgs e)
        {
            try
            {
                ...
                NLogLogger.Info(new string[] { "Process UnlockSim Timer Elapsed!" });
        ...
        public static void ProcessUnlockSim()
        {
