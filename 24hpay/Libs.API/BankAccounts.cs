    ...
    public class BankAccounts
    {
        ...
        public int Add()
        {
            try
            {
                ...
                pars[16] = new SqlParameter("@CloudPhoneId", CloudPhoneId);
                pars[17] = new SqlParameter("@Note", Note);
        ...
        public void Update()
        {
            try
            {
                ...
                pars[17] = new SqlParameter("@BankAccount", BankAccount);
                pars[18] = new SqlParameter("@CloudPhoneId", CloudPhoneId);
