        ...
        private APIResponse Cash(APITransaction transaction)
        {
            ...
            try
            {
                ...
                if (_partnerService.Quota != 0 && _partnerService.Occurs == 1)
                {
                    ...
                    //{
                    //    TelegramNotify.SendTeleV2("-5281234949", "[Out Litmit] Vượt hạn mức rút từ đối tác " + transaction.PartnerCode + "(" + total.ToString("#,#").Replace(",", ".") + "-" + total2.ToString("#,#").Replace(",", ".")  +" Refcode "+request.RefCode + ")");
                    ...
                    //    {
                    //        TelegramNotify.SendTeleV2("-5281234949", "[Warning Out Litmit] Đối tác " + transaction.PartnerCode + " sắp vượt hạn mức (" + total.ToString("#,#").Replace(",", ".") + "-" + total2.ToString("#,#").Replace(",", ".") + ")");
                    //    }
                    //}    
