...
namespace Libs.CardTelco.Vcoin
{
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name = "cardSoap", Namespace = "VTCOnline.Card.WebAPI")]
    public partial class card : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        {
            //this.Url = "http://sandbox2.vtcebank.vn/WSCard2010/card.asmx";
            this.Url = url;
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("VTCOnline.Card.WebAPI/Request", RequestNamespace = "VTCOnline.Card.WebAPI", ResponseNamespace = "VTCOnline.Card.WebAPI", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string Request(int PartnerID, string RequestData)
        {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginRequest(int PartnerID, string RequestData, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("Request", new object[] {
                    PartnerID,
                    RequestData}, callback, asyncState);
        }
        ...
        /// <remarks/>
        public void RequestAsync(int PartnerID, string RequestData)
        {
            this.RequestAsync(PartnerID, RequestData, null);
        }

        /// <remarks/>
        public void RequestAsync(int PartnerID, string RequestData, object userState)
        {
            ...
            this.InvokeAsync("Request", new object[] {
                    PartnerID,
                    RequestData}, this.RequestOperationCompleted, userState);
        }
