...
{
    public class GateCardSandbox : ICardTelcoHandler
    {

        // Cấu hình kết nối Production 
        protected string webserviceUrl = "https://sandbox-ops.gate.vn:7001/Igate_WS/Route?wsdl";

        protected string merchantID = "1339";
        protected string secretKey = "7fb98e3833de1960d3f6e8dc488802ed";
        protected string PrivateKey = "ca4c215a";
        protected string KeyPath = "\\1339.p12";

        protected JavaScriptSerializer serializer = new JavaScriptSerializer();
        protected string providerName = "gatesb";
