    ...
    <section class="content">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-left">
                ...
                <%if (cbxIsProvider.Checked || cbxIsTopup.Checked)
                    {%>
                <li><a href="#sales-chart-provider" data-toggle="tab">Nhà cung cấp - Gạch thẻ</a></li>
                <li><a href="#sales-chart-provider3" data-toggle="tab">Nhà cung cấp - Mua mã thẻ - Topup</a></li>
                <li><a href="#sales-chart-provider2" data-toggle="tab">Nhà cung cấp - Bank</a></li>
                <%}%>
            ...
            <div class="tab-content no-padding">
                <div class="chart tab-pane active" id="revenue-chart">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="txtIp">Login IP</label>
                            <asp:TextBox ID="txtIp" runat="server" CssClass="form-control" TextMode="MultiLine"
                                Rows="5"></asp:TextBox>
                        ...
                        <div class="checkbox">
                            <label for="cbxIsAdmin">
                                <asp:RadioButton ID="cbxIsPartner" Checked="false" runat="server" GroupName="TypeUser"></asp:RadioButton>
                                User Partner   
                            </label>
                        </div>
