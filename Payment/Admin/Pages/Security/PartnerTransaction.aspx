                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="drpBankCode" runat="server" CssClass="form-control select2">
                                        ...
                                        <asp:ListItem Value="VIKKI">(VIKKI) - VIKKI</asp:ListItem>
                                ...
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Eval("RateIn")%> - <%#Eval("RateOut")%></td>
                                            ...
                                            <td>
                                                ...
                                                &nbsp; |&nbsp;
                                                 <asp:HyperLink NavigateUrl='<%# FixtUrl(Eval("Id").ToString()) %>' Visible='<%# Eval("Status").ToString() == "0" %>' runat="server"> Cập nhật </asp:HyperLink>
                                                &nbsp; |&nbsp;
