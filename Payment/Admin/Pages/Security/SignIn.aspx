...
<head>
    ...
    <% if (Request.Url.Host.Contains("qxpay.info"))
        { %>
    <title>QXPay| Login</title>
    <% }
        else
        { %>

    <% if (Request.Url.Host.Contains("tn99.info"))
        { %>
    <title>TN99| Login</title>
    <% }
        else
        { %>
    ...
    <% if (Request.Url.Host.Contains("qxpay.info"))
        { %>
     <link rel="stylesheet" href="../Content/dist/css/skin2026.css?vs=2602">
      <% }%>

     <% if (Request.Url.Host.Contains("tn99.info"))
     { %>
  <link rel="stylesheet" href="../Content/dist/css/beer_golden_adminlte_skin.css?vs=2602">
   <% }%>

     <% if (Request.Url.Host.Contains("qxpay.info"))
        { %>
    <link rel="icon" type="image/svg+xml" href="/cmspay/fav.svg">
    <% }
        else
        { %>
    <% if (Request.Url.Host.Contains("tn99.info"))
    ...
    <link rel="icon" type="image/png" href="/cmspay/fav2.png">
    <% }
        else
        { %>
    ...
    <form id="form1" runat="server">
        <div class="login-box">
            ...
            <div class="login-logo">
                <a href="<%=Constant.ADMIN_PATH %>"><b>QXPay</b>CMS</a>
            </div>
            <% }
                else
                { %>
            ...
            <% if (Request.Url.Host.Contains("tn99.info"))
                { %>
            <div class="login-logo">
                <a href="<%=Constant.ADMIN_PATH %>"><b>TN99</b>CMS</a>
            </div>
            <% }
                else
                { %>
            <div class="login-logo">
                <a href="<%=Constant.ADMIN_PATH %>"><b>FastPay</b>CMS</a>
            </div>
