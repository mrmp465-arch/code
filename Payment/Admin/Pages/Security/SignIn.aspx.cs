...
public partial class Pages_Security_SignIn : System.Web.UI.Page
{
    ...
    protected void btSignIn_Click(object sender, EventArgs e)
    {
        ...
        {
           //không cho vs8
            if (_User.UserName == "tppay" || _User.UserName == "vs8" || _User.UserName.Contains("vs8sp") )
            {
            ...
            //không cho tn
            if (_User.UserName.StartsWith("tn") )
            {
                PanelMessage.Visible = true;
                lblMessage.Text = "Invalid password or login name";
                txtUserName.Focus();
        ...
        else
        {
            ...
            if (Request.Url.Host.Contains("tn99.info"))
            {
                ...
                //không có qx
                if (_User.UserName == "knqpay" || _User.UserName.Contains("qx88") || _User.UserName.Contains("qxkpmg"))
                {
                    PanelMessage.Visible = true;
        ...
        if (!string.IsNullOrEmpty(_User.Ip))
        {
            ...
            {
                NLogLogger.Info(new string[] { "SignIn Fail", "", txtUserName.Text.ToString(), GetIP() });
                PanelMessage.Visible = true;
