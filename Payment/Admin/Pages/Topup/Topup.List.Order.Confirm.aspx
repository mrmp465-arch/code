<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="Topup.List.Order.Confirm.aspx.cs" Inherits="Pages_Topup_Topup_List_Order_Confirm" %>
    ...
    <section class="content">
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
                ...
                <li class="active"><a href="#revenue-chart" data-toggle="tab">Order đã chốt</a></li>
            </ul>
                                ...
                                <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_OnItemCommand">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Eval("LastTime")%></td>
                                            <td>
                                               <a href="<%= Constant.ADMIN_PATH %><%= Resources.Url.TopupList %>?id=<%#Eval("OrderNo") %>">Xem</a><%-- |  <a href="<%= Constant.ADMIN_PATH %><%= Resources.Url.TopupEditOrder %>?o=<%#Eval("OrderNo") %>&u=<%#Eval("UserId")%>&ur=<%=HttpUtility.UrlEncode(HttpContext.Current.Request.Url.ToString())%>&ic=1">Sửa</a>--%>
