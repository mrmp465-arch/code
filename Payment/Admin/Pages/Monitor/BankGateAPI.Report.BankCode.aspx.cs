...
public partial class Pages_Monitor_BankGateAPI_Report_BankCode : System.Web.UI.Page
{
    ...
    private void GetList()
    {
        ...
        rptList.DataSource = _BankGateAPI.ReportBankCode(providerCodes, partnerCodes, year, month, day, ref totalTransaction, ref totalAmount);
