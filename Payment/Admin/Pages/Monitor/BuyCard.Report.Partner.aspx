<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="BuyCard.Report.Partner.aspx.cs" Inherits="Pages_Monitor_BuyCard_Report_Partner" %>
    ...
    <section class="content">
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
                ...
                <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.BuyCardReport %>">Theo thời gian</a></li>
                                ...
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr class="trId<%#Eval("PartnerCode") %> <%#Eval("TrClass") %>  tr<%#Eval("Row") %> closes" data-id="<%#Eval("PartnerCode") %>">
                                            ...
                                            <td style="text-align: center;" class="td1 clicktd"><%#Eval("PartnerId") %> </td>
                                            <td class=" clicktd" style="text-align: center;"><%#Eval("Provider") %></td>
