...
public partial class Pages_Monitor_BankGateAPI_Report : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        AppUtils.CheckRoles(Resources.Url.BankGateAPIReport);
    ...
    private void GetList()
    {
        ...
        rptList.DataSource = _BankGateAPI.Report(bankCode, partnerCodes, providerCodes, year, month, day, ref totalTransaction, ref totalAmount);
