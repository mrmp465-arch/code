<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="BuyCard.Report.CardType.aspx.cs" Inherits="Pages_Monitor_BuyCard_Report_CardType" %>
    ...
    <section class="content">
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
                ...
                <li class="active"><a href="#revenue-chart" data-toggle="tab">Theo loại thẻ</a></li>
                <%if (AppUtils.IsAdmin)
                    {%>
                        ...
                        <table class="table table-striped" id="TableResponsive" style="margin-top: 20px; clear: both;">
                            ...
                            <tbody>
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr id="tr<%# Container.ItemIndex + 1 %>" class="clicktr" data-url="&CardType=<%#Eval("Provider") %>&PartnerID=<%#Eval("PartnerCode") %>&ProviderCode=<%#Eval("ProviderCode") %>">
                                            <td ></td>
                                            <td><%#Eval("Provider") %></td>  
