<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="CardAPI.Report.CardType.aspx.cs" Inherits="Pages_Monitor_CardAPI_Report_CardType" %>
                        ...
                        <table class="table table-striped" id="TableResponsive" style="margin-top: 20px; clear: both;">
                            ...
                            <tbody>
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr id="tr<%# Container.ItemIndex + 1 %>" data-url="&CardType=<%#Eval("CardType") %>&PartnerID=<%#Eval("PartnerCode") %>&Provider=<%#Eval("Provider") %>">
                                            <td></td>
                                            <td><%#Eval("CardType") %></td>
