<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="BankGateAPI.Monitor2.aspx.cs" Inherits="Pages_Monitor_BankGateAPI_Monitor2" %>
    ...
    <section class="content">
        <div class="row">
         ...
         <asp:ListItem Text="Thất bại" Value="-1"></asp:ListItem>--%>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1" style="display:none">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="input-group">
                                <span class="input-group-addon"><%= Resources.Pay.OrderNo%></span>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2">
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <asp:CheckBox runat="server" ID="cbDay" Checked="False" />
                                </span>
                                <span class="form-control">Khác ngày</span>
                            </div>
                            <!-- /input-group -->
                        </div>
                        <% } %>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="font-size: 105%">
                                                ...
                                                <asp:Label runat="server" Visible='<%# Eval("PartnerCode").ToString().Contains("mark") && Eval("BankCode").ToString()=="MOMO" %>'>&nbsp;&nbsp;<a href="<%=Constant.ADMIN_PATH + "/pages/monitor/BankGateAPI.FixMomo.aspx"%>?id=<%#Eval("TransactionID") %>"> [Sửa nd] </a> </asp:Label>
