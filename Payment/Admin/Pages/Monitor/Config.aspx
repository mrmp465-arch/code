        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <span class="form-control" style="font-weight: bold">Rút momo</span>
                    ...
                    <div class="col-md-2" style="display: none">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <span class="form-control" style="font-weight: bold">Duyệt bank out</span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="txtBankCodeInMaintain">Danh sách bank VS8(ACB,MB,BIDV,VCB)</label>
                            <asp:TextBox ID="txtBankCodeVS" runat="server" CssClass="form-control" placeholder=""></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <label for="txtName">Số tiền rút momo tối thiểu</label>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <label for="txtName">Số tiền rút momo tối đa</label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="txtName">Ngưỡng rút tiền momo</label>
