                            ...
                            if (item.ProviderCode != Provider)
                            {
                                ...
                                if (Provider != item.ProviderCode)
                                {
                                    ...
                                    if (totalRecord > 0)
                                    {
                                        ...
                                        {
                                            dbCardStore.Update_byPacketId(item2.Id, item2.ProviderCode, item2.CardType, Convert.ToDateTime(item2.ExpireDate), Convert.ToInt32(item2.CardValue), Convert.ToBoolean(item2.IsActive));
                                        }
                                    }
                                }
                            }
