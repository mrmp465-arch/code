<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountOutside.aspx.cs" MasterPageFile="~/Layout/Layout.master" Inherits="Pages_BankEWalletService_InternalTransfer_AccountOutside" %>
    ...
    <section class="content">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-left">
                ...
                <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.ITransfer %>">Lệnh chuyển tiền</a></li>
               
                <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.ITAccount %>">Tài khoản chứa</a></li>
                 <li class="active"><a href="#">Tài khoản ngoài</a></li>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="drpBankCode" runat="server" CssClass="form-control select2">
                                            ...
                                            <asp:ListItem Value="VIETBANK">VietBank</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
