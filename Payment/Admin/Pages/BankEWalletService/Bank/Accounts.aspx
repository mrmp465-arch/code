            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box-tools" style="margin-top: 10px;">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2">
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="drpComputer" runat="server" CssClass="form-control select2">
                                    ...
                                    <asp:ListItem Text="PC101" Value="PC101"></asp:ListItem>
                                    <asp:ListItem Text="PC102" Value="PC102"></asp:ListItem>
                                    <asp:ListItem Text="PC103" Value="PC103"></asp:ListItem>
                                    <asp:ListItem Text="PC104" Value="PC104"></asp:ListItem>
                                    <asp:ListItem Text="PC105" Value="PC105"></asp:ListItem>
                                    <asp:ListItem Text="PC106" Value="PC106"></asp:ListItem>
                                    <asp:ListItem Text="PC107" Value="PC107"></asp:ListItem>
                                    <asp:ListItem Text="PC108" Value="PC108"></asp:ListItem>
                                    <asp:ListItem Text="PC109" Value="PC109"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2">
                            <div class="input-group">
                                <span class="input-group-addon" style="padding: 5px;">Số tiền QR(M) </span>
                                <asp:TextBox ID="txtAmount" runat="server" Text="100" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4" style="font-weight: bold; float: left">
                            <asp:Label runat="server" ID="lblTota2"></asp:Label>
                        </div>
