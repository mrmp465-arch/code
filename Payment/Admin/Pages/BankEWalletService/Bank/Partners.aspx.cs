...
public partial class Pages_BankEWalletService_Bank_Partners : System.Web.UI.Page
{
    ...
    {
        Response.Redirect(Constant.ADMIN_PATH + Resources.Url.BankPartnerAdd);
    }
    ...
    {
        var data = new PartnerBank().GetListPartner();
    ...
    protected void btApply_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < rptList.Items.Count; i++)
        {
            ...
            new PartnerBank().UpdatePartner(_Partner);
        }
        BindData();
    }
    ...
    protected void Delete_Command(Object sender, CommandEventArgs e)
    {
        ...
        new PartnerBank().DeletePartner(Id);
        BindData();
    }
