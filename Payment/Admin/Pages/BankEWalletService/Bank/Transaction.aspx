            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <asp:Label runat="server" Text="Danh sách log giao dịch" CssClass="title"></asp:Label>
                        </h3>
                    </div>
     ...
     : ""
                                            ...
                                            <td>
                                                ...
                                                <asp:HyperLink
                                                    ID="lnbill"
                                                    CssClass="lightbox"
                                                    NavigateUrl='<%# "https://momo.opaps.info/Pages/Detail2.aspx?orderNo=" + Eval("Id") %>'
                                                    runat="server"
                    ...
                    <div class="box-footer">
                        <input type="button" class="btn btn-info pull-right" value="export Excel" onclick="exportTableToExcel('TableResponsive', 'fpgiaodich')" />
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
