                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2">
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="drpGroup" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="drpGroup_SelectedIndexChanged">
                                    ...
                                    <asp:ListItem Text="5pay" Value="5pay"> </asp:ListItem>
                                    <asp:ListItem Text="hyn" Value="hyn"></asp:ListItem>
                                    <asp:ListItem Text="nc" Value="nc"></asp:ListItem>
                                    <asp:ListItem Text="levi" Value="levi"></asp:ListItem>
                        ...
                        <table class="table table-striped" id="TableResponsive">
                            <thead>
                                <tr>
                                    ...
                                    <th>TK đối ứng</th>
                                    <th>Chiết khấu(bank|momo|bankout|momoout|vtt|vnp|vms|cardout)</th>
                                    <th>Kích hoạt</th>
                                    <%--<th>Hoạt động</th>--%>
                                    <th>Tác vụ</th>
                                </tr>
