                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <div class="form-group" >
                                        <label for="txtSMSCommand">Tài khoản đại lý </label>
                                        <asp:TextBox ID="txtSMSCommand" runat="server" CssClass="form-control" placeholder="tk đại lý"></asp:TextBox>
                                    </div>
                                    <div class="form-group" >
                                        <label for="txtSMSPlusCommand"> Số tiền xác nhận đơn rút </label>
                                          <asp:TextBox ID="txtSMSPlusCommand" runat="server" CssClass="form-control" placeholder="Số tiền xác nhận đơn rútt"></asp:TextBox>
                                    ...
                                    <div class="form-group" >
                                        <label for="txtSMSPlusUrl">TelegroupID</label>
                                       <%-- <asp:DropDownList ID="drlBankGroup" runat="server" CssClass="form-control ">
                                        </asp:DropDownList>--%>

                                         <asp:TextBox ID="txtSMSPlusUrl" runat="server" CssClass="form-control" placeholder="TelegroupID"></asp:TextBox>
                                    </div>
                                    <div class="form-group"  >
                                        <label for="txtSMSPlusCommand">Nhóm</label>
                                      <asp:TextBox ID="txtSMSUrl" runat="server" CssClass="form-control" placeholder="Nhóm"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group" >
                                    <label for="txtPublicKey">RequestType</label>
                                    <asp:DropDownList ID="txtRequestType" runat="server" CssClass="form-control">

                                        <asp:ListItem Value="0">Request - Response</asp:ListItem>
                                        <asp:ListItem Value="1">Full CallBack</asp:ListItem>
                        ...
                        <table class="table table-condensed">
                            <tbody>
                                <tr>
                                    ...
                                    <th></th>
                                    <th>Occurs</th>
                                    <th style="display: none">CommandCode</th>
                                    <th>IP truy cập</th>
                                    <th>Trạng thái</th>
                                </tr>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-top:10px;">
                                                <asp:Label ID="lbQuota" runat="server">
