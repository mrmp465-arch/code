...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Quản lý ài khoản Bank Hold Momo</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-left">
                ...
                <li class="active"><a href="#">Tài khoản Bank Hold Momo</a></li>
            </ul>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="drpBankCode" runat="server" CssClass="form-control select2">
                                            ...
                                            <asp:ListItem Value="VPB">VPBank - Ngân hàng TMCP Việt Nam Thịnh Vượng</asp:ListItem>
                                             <asp:ListItem Value="NAB">Ngân Hàng Nam Á</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
