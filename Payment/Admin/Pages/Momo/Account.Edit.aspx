                ...
                <div class="col-xs-12">
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs pull-right ui-sortable-handle" id="accountTabs">
                            <% if (RoleUpload)
                                { %>
                            <li class=""><a href="<%=Constant.ADMIN_PATH %><%=Resources.Url.MomoUploadImage%>?id=<%=Id%>">Ảnh</a> </li>
                            <% } %>
                            <% if (RoleTransfer)
                                { %>
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList runat="server" ID="ddlBank" class="form-control select2" Style="width: 100%;" required="true">
                                                        ...
                                                        <asp:ListItem Value="STB">Sacombank</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="form-group">
                            ...
                            <div class="chart tab-pane active" id="account-info">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="txtSolution">By Pass 20M  *</label>
                                        <asp:DropDownList ID="drp20M" runat="server" CssClass="form-control">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        &nbsp;&nbsp;
                                        <asp:Button ID="btReset" runat="server" Text="Reset" CssClass="btn btn-info " OnClick="btReset_Click"></asp:Button>
