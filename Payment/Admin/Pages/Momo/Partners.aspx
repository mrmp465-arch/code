<%@ Page Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="Partners.aspx.cs" Inherits="Pages_Momo_Partners" %>
                    ...
                    <div class="box-tools" style="margin-top: 10px;">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2">
                            <div class="input-group">
                                <span class="input-group-addon" style="padding: 5px;">Partner Name</span>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                           ...
                                           <%--  <td><%#Eval("Description") %></td>--%>
                                            <td>
                                              <asp:TextBox ID="txtCallback" runat="server" CssClass="form-control" style="width:80%;"  placeholder="Nhập callback In đến kênh" Text='<%#Eval("InCallbackUrl") %>'></asp:TextBox>
                                            </td>
