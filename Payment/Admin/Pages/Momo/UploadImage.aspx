<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout/Layout.master" CodeFile="UploadImage.aspx.cs" Inherits="Pages_Momo_UploadImage" %>
                ...
                <div class="col-xs-12">
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs pull-right ui-sortable-handle" id="accountTabs">
                            <li class="active"><a href="#account-Ảnh"> Ảnh</a></li>
                            <li class=""><a href="<%=Constant.ADMIN_PATH %><%=Resources.Url.MomoAccountEdit%>?id=<%=Id%>#balance-info" >Số dư tài khoản</a></li>
                            <li><a href="<%=Constant.ADMIN_PATH %><%=Resources.Url.MomoAccountEdit%>?id=<%=Id%>#account-info" >Thông tin tài khoản</a></li>
                                    ...
                                    <div class="box box-solid">
                                        ...
                                        <blockquote style="border-color: green">
                                            <p>
                                                Trạng thái Detech
                                               <h5>
                                                   <asp:Label ID="lbDetech" runat="server"></asp:Label><br />
                                ...
                                <div class="col-md-9">
                                    <blockquote id="profileimg" runat="server" style="border-color: blue" visible="true">
                                        ...
                                        <div class="row profileimg">
                                            ...
                                            <div class="form-group" style="text-align: left; font-size: 14px; margin-top: 20px">
                                                <div class="checkbox">
