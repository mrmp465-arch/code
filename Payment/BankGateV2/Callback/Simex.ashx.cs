...
{
    /// <summary>
    /// Summary description for Simex
    /// </summary>
    public class Simex : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var cbObj = new PostGetHelper().GetFromQueryString<Libs.BankDirect.Simex.SimexBankLib.Callback>();
