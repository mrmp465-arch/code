...
namespace Libs.Report
{
    ...
    public class BankGateAPI
    {
        ...
        public List<BankReportProfit> ReportProfit(string partnerCodes, DateTime beginTime, DateTime endTime)
        {
        ...
        // Lấy danh sách
        public DataTable GetTable(int top, string partnerCodes, string provider, DateTime fromdate, DateTime requestTime, int? status, string bankCode,string refCode, string orderNo, string orderInfo,long? amount=null,string bankid="",int type=1, bool isDay = false)
        {
            DBHelper db = new DBHelper(Configs.VPGAPIReportConnectionStrings);
            return db.GetDataTableSP("sp_BankGateAPI_Search"
               ...
               , new SqlParameter("@RequestTime", requestTime)
                , isDay == false ? new SqlParameter("@IsDay ", false) : new SqlParameter("@IsDay ", isDay)
        ...
        public List<BankGateAPIReport> ReportDashboard(string partnerCodes, DateTime beginTime, DateTime endTime,string bankId="",int type=1)
        {
            DBHelper db = new DBHelper(Configs.VPGAPIReportConnectionStrings);
            SqlParameter[] pars = new SqlParameter[5];
            pars[0] = string.IsNullOrEmpty(partnerCodes) ? new SqlParameter("@PartnerCodes", DBNull.Value) : new SqlParameter("@PartnerCodes", partnerCodes);
        ...
        public List<BankGateAPI> GetBankCode()
        {
            ...
            data.Add(new BankGateAPI { BankCode = "BIDV" });
        ...
        public void UpdateCMSV2()
        {
            ...
            pars[8] = new SqlParameter("@Fee", Fee);
            pars[9] = new SqlParameter("@Signature", Signature);
            pars[10] = new SqlParameter("@ProviderCode", ProviderCode);
            pars[11] = new SqlParameter("@Reward", Reward);
            db.ExecuteNonQuerySP("sp_BankGateAPI_UpdateCMSV2", pars);
            ReturnValue = Convert.ToInt32(pars[0].Value);
        }
