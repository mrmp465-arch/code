    ...
    public class UsersService : IUsersService
    {
            ...
            try
            {
              ...
              new DBHelper(Config.MainConnectionString).GetInstanceSP<Users>("SP_User_GetByUsername",
                ...
                if(user.Type==4)
                {
                    ...
                    user.PercentVTTQ += parrentUser.PercentVTTQ;
                    user.PercentVNPQ += parrentUser.PercentVNPQ;
        ...
        public int UpdateUsers(Users users)
        {
            try
            {
                ...
                pars[25] = new SqlParameter("@_MaxDay", users.MaxDay);
                pars[26] = new SqlParameter("@_PercentGarena", users.PercentGarena);
                pars[27] = new SqlParameter("@_PercentZing", users.PercentZing);
                pars[28] = new SqlParameter("@_StatusGarena", users.StatusGarena);
                pars[29] = new SqlParameter("@_StatusZing", users.StatusZing);
                pars[30] = new SqlParameter("@_StatusVTC", users.StatusVTC);
                pars[31] = new SqlParameter("@_PercentVTC", users.PercentVTC);
                pars[32] = new SqlParameter("@_C1User", users.C1User);
                pars[33] = new SqlParameter("@_PercentVNPQ", users.PercentVNPQ);
                pars[34] = new SqlParameter("@_PercentVTTQ", users.PercentVTTQ);
