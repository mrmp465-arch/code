...
namespace BankGateTest
{
    public partial class Card : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //ParseMoMoQR(qrData);
            SendConfirmMessage("-4886123515", "2");
        }

        public static void SendConfirmMessage(string chatId, string requestId)
        {
            string BotToken = "7593090326:AAFAMnx9Bw6akr6mw9YLrtohHBzybgoqhpo";
            string keyboard =
                "{\"inline_keyboard\":[[" +
