<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BankGateAPI.Report.DoiSoatTotal.aspx.cs" Inherits="Pages_Monitor_BankGateAPI_Report_DoiSoatTotal" %>
            ...
            <div class="tab-content no-padding">
                <div class="chart tab-pane <% if (Type == "1" || Type == null)
                        ...
                        <table class="table table-bordered nowrap" id="TableResponsive1" style="margin-top: 20px; clear: both;" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr style="vertical-align: middle;">
                                    ...
                                    <%} %>
                                    <%if (count2 > 0)
                                        { %><td rowspan="1"><%= item.BankCode %></td>
                                    <%} %>
                                    <%--<td style="vertical-align: middle; text-align: center;"><%= item.Provider %></td>--%>

                                    <td class="right"><%= item.ReturnValue.ToString("N0").Replace(".", ".") %></td>
                                    <td class="right"><%= item.ReturnTotalValue.ToString("N0").Replace(".", ".") %></td>
                                    <td class="right"><%=item.Fee.ToString("N0").Replace(".", ".") %></td>
                                </tr>
                                <% Total += item.Reward;
                                        }
                                    } %>
                    ...
                    <div class="box-footer">
                        <input type="button" class="btn btn-info pull-right" value="export Excel" onclick="exportThisWithParameter('TableResponsive1', 'DoiSoat')" />
                    </div>
                </div>
