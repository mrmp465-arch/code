...
public partial class Pages_Monitor_BankGateAPI_Monitor : System.Web.UI.Page
{
    ...
    protected void ExportTran2_Click(object sender, EventArgs e)
    {
        ...
        var data = new BankGateAPI().GetTable(200000, partnerCodes, providerCodes, fromDate, requestTime, 1, string.Empty, string.Empty, string.Empty, string.Empty, null, txtBankId.Text);
