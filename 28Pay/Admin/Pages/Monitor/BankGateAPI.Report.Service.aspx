<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="BankGateAPI.Report.Service.aspx.cs" Inherits="Pages_Monitor_BankGateAPI_Report_Service" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>Nạp bank
            <small>Báo cáo thanh toán theo dịch vụ  </small>
        </h1>
        <ol class="breadcrumb">
