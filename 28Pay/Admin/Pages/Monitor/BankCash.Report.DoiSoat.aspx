<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="BankCash.Report.DoiSoat.aspx.cs" Inherits="Pages_Monitor_BankCash_Report_DoiSoat" %>
    ...
    <section class="content">
      ...
      { %><td rowspan="<%=count2 %>"><%= item.BankCode %></td>
                    ...
                    <div class="box-footer">
                         <button ID="Button1" type="button" class="btn btn-primary pull-right" style="margin-right: 5px;" runat="server" OnServerClick="ExportTran_Click">
      ...
      { %><td rowspan="<%=count2 %>"><%= item.BankCode %></td>
                    ...
                    <div class="box-footer">
                       <button ID="Button2" type="button" class="btn btn-primary pull-right" style="margin-right: 5px;" runat="server" OnServerClick="ExportTran2_Click">
                                <i class="fa fa-download"></i> Export Excel
                            </button>
                    </div>
                </div>
