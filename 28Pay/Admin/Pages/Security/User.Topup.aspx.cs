...
public partial class Pages_Security_User_Topup : System.Web.UI.Page
{
    ...
    protected void btAdd_Click(object sender, EventArgs e)
    {
        ...
        if(amount>0)
        {
            ...
            TelegramClient.SendTeleV2("-4873375848", "Cộng tiền  " + amount.ToString("#,#").Replace(",", ".") + " cho user " + name + " Từ tài khoản " + AppUtils.UserName);
        ...
        else
        {
            ...
            TelegramClient.SendTeleV2("-4873375848", "Trừ tiền  " + amount.ToString("#,#").Replace(",", ".") + " cho user " + name + " Từ tài khoản " + AppUtils.UserName);
