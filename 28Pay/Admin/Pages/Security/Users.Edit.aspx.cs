...
public partial class Pages_Security_Users_Edit : System.Web.UI.Page
{
        ...
        if (IsUserPartner == 1)
        {
            ...
            if (listpartnerDiscount != null)
            {
                if (listpartnerDiscount.Exists(x => x.Date.Day == 1))
                {
                    ...
                    txtDiscountZING.Text = ((float)_partnerDiscount.DiscountZING * 100).ToString();
                    txtDiscountVCOIN.Text = ((float)_partnerDiscount.DiscountGATE * 100).ToString();
                }
                else
                {
                    ...
                    txtDiscountZING.Text = "0.0000";
                    txtDiscountVCOIN.Text = "0.0000";
                }
            }
            else
            {
            ...
            txtSMSPlusCommand.Text = _Partner.SMSUrl;
    ...
    protected void btUpdate_Click(object sender, EventArgs e)
    {
        ...
        if (_User.IsPartner == 1)
        {
            ...
            _Partner.SMSUrl = txtSMSPlusCommand.Text.Trim();
            _Partner.SMSPlusUrl = txtSMSPlusUrl.Text.Trim();
            _Partner.SMSCommand = txtSMSCommand.Text.Trim();
            //Partner.SmsPlusCommand = txtSMSPlusCommand.Text.Trim();
            ...
            decimal DiscountZING;
            bool isDecimal12 = decimal.TryParse(txtDiscountZING.Text, out DiscountZING);
            DiscountZING = DiscountZING / 100;

            decimal DiscountVCOIN;
            bool isDecimal13 = decimal.TryParse(txtDiscountVCOIN.Text, out DiscountVCOIN);
            DiscountVCOIN = DiscountVCOIN / 100;
            ...
            obj.DiscountGATE = DiscountVCOIN;
            obj.RewardGATE = 0;
