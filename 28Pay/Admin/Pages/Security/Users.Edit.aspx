            ...
            <div class="tab-content no-padding">
                ...
                <div class="chart tab-pane active" id="revenue-chart">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label for="txtDiscountVTT">Chiếu khấu ZING </label>
                            <asp:TextBox ID="txtDiscountZING" runat="server" CssClass="form-control" placeholder=""></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label for="txtDiscountVTT">Chiếu khấu VCOIN </label>
                            <asp:TextBox ID="txtDiscountVCOIN" runat="server" CssClass="form-control" placeholder=""></asp:TextBox>
                        </div>
                        <div class="form-group">
