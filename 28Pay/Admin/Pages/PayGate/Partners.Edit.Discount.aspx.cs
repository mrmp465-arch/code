                ...
                if (ext == ".xlsx")
                {
                    ...
                    if (tempDataTable)
                    {
                        var _userLog = new UserLog
                        {
                            ...
                            ActionName = "Cập nhật chiếu khấu đối tác",
                            Description = "Cập nhật chiếu khấu đối tác"
                        };
                        _userLog.Add();
                ...
                foreach (var ws in pck.Workbook.Worksheets)
                {
                    ...
                    foreach (DataRow row in tbl.Rows)
                    {
                        if (!string.IsNullOrEmpty(row.ItemArray[1].ToString()))
                        {
                            ...
                            obj.RewardVTT = Convert.ToDecimal(row.ItemArray[3].ToString());
                            obj.DiscountVNP = Convert.ToDecimal(row.ItemArray[4].ToString());
                            obj.RewardVNP = Convert.ToDecimal(row.ItemArray[5].ToString());
                            obj.DiscountVMS = Convert.ToDecimal(row.ItemArray[6].ToString());
                            obj.RewardVMS = Convert.ToDecimal(row.ItemArray[7].ToString());
                            //obj.DiscountGATE = Convert.ToDecimal(row.ItemArray[8].ToString());
                            //obj.RewardGATE = Convert.ToDecimal(row.ItemArray[9].ToString());
                            //obj.DiscountZING = Convert.ToDecimal(row.ItemArray[10].ToString());
                            //obj.RewardZING = Convert.ToDecimal(row.ItemArray[11].ToString());
                            
                           
                            obj.DiscountZING = 0 ;
                            obj.RewardZING = 0;
                            obj.DiscountBANKTRANFER = Convert.ToDecimal(row.ItemArray[8].ToString());
                            obj.RewardBANKTRANFER = Convert.ToDecimal(row.ItemArray[9].ToString());
                            obj.DiscountMOMO = Convert.ToDecimal(row.ItemArray[10].ToString());
                            obj.RewardMOMO = Convert.ToDecimal(row.ItemArray[11].ToString());
                            obj.DiscountVTTOUT = Convert.ToDecimal(row.ItemArray[12].ToString());
                            obj.RewardVTTOUT = Convert.ToDecimal(row.ItemArray[13].ToString());
                            obj.DiscountBANKOUTTRANFER = Convert.ToDecimal(row.ItemArray[14].ToString());
                            obj.RewardBANKOUTTRANFER = Convert.ToDecimal(row.ItemArray[15].ToString());
                            obj.DiscountMOMOOUT = Convert.ToDecimal(row.ItemArray[16].ToString());
                            obj.RewardMOMOOUT = Convert.ToDecimal(row.ItemArray[17].ToString());
                            ...
                            try
                            {
                                if (!string.IsNullOrEmpty(row.ItemArray[18].ToString()))
                                {
                                    obj.DiscountGATE = Convert.ToDecimal(row.ItemArray[18].ToString());
                                    obj.RewardGATE = Convert.ToDecimal(row.ItemArray[19].ToString());
                                }
                            }
                            catch
                            {
                            ...
                            obj.Add();
                            obj.DeleteCache(AppUtils.RequestCode("code"));
                            obj.DeleteCache("");
                        }
                    }
