...
public partial class Pages_PayGate_Provider_List : System.Web.UI.Page
{
    ...
    protected void btApply_Click6(object sender, EventArgs e)
    {
        updateProvider(rptList6, 5);
    }
    public void updateProvider(Repeater rptList, int _Type)
    {
        for (int i = 0; i < rptList.Items.Count; i++)
        {
            ...
            //NLogLogger.Info(new string[] { _Provider.ProviderId.ToString(), "amoutlist", _Provider.AmoutList });
            _Provider.Status = cbx.Checked ? 1 : 0;
            _Provider.Quota = Convert.ToInt64(tqtValue) * 1000000;
    ...
    protected void BindData()
    {
        ...
        DataView dv6 = new Providers().GetTable().DefaultView;
        dv6.Sort = "OrderNo asc";
        dv6.RowFilter = "Type = 5";
        DataTable sortedDT6 = dv6.ToTable();
        rptList6.DataSource = sortedDT6;
        rptList6.DataBind();
    ...
    {
        Response.Redirect(Constant.ADMIN_PATH + Resources.Url.ProviderAdd + "?type=15");
    }
    ...
    protected void btAdd_Click6(object sender, EventArgs e)
    {
        Response.Redirect(Constant.ADMIN_PATH + Resources.Url.ProviderAdd + "?type=5");
    }
