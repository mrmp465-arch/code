...
public partial class Pages_BankEWalletService_Bank_Edit_TranIn : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        //        contentSpan.InnerText = "Bạn chưa có quyền sửa đơn lớn. Vui lòng liên hệ với quản trị để xử lý";
        //        return;
        //    }
        //}
    ...
    protected void btnEditTran_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            _userLog.Add();
            TelegramClient.SendTeleV2("-1003843912663", "Cập nhật nội dung giao dịch bank " + _bankTranLog.Id + " | " + _bankTranLog.Comment + " | " + _bankTranLog.Amount.GetValueOrDefault().ToString("#,#").Replace(",", ".") + " Từ tài khoản " + AppUtils.UserName);
