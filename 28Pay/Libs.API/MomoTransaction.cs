...
namespace Libs.API
{
    ...
    public class MomoTransaction
    {
        ...
        public List<MomoTransaction> GetList(int Top, long? id, string PartnerCode, string PartnerMomoId, string MomoTransId, string MomoId, string CommandCode, DateTime creatTime, int? status, bool isByPass10k, string refCode, string comment)
        {
            int? amount = null;
            if (isByPass10k)
                amount = 10000;
        ...
        public List<MomoReport> Report(int year, int month, int day)
        {
            DBHelper db = new DBHelper(Configs.VPGMOMOReportConnectionStrings);
        ...
        public List<MomoReport> ReportDaily(DateTime beginTime, DateTime endTime)
        {
            DBHelper db = new DBHelper(Configs.VPGMOMOReportConnectionStrings);
