...
namespace Libs.BankDirect
{
    public class TelegramNotify
    {
        ...
        //        var requestUrl = string.Format("https://api.telegram.org/bot8605707960:AAFl2eXsuqMvMk3KVo7JyK2b9iaLQKj8AFI/sendMessage?chat_id={1}&parse_mode=html&text={0}", message, id);
        //        var webclient = new WebClient();
