...
namespace APIGame
{
    ...
    public class UtilsGarena
    {
        ...
        public static async Task<GameCookie> GetImageBase64(string url, CookieContainer cookieContainer)
        {
            ...
            {
                NLogLogger.Info(new string[] { "UtilsGarena", "GetImageBase64", "Exception", e.Message });
            }
            return null;
        }

        public static string DeCaptcha(string url, CookieContainer cookieContainer, string tranId, string tranId3rd)
        {
            try
            {
                ...
                if (capImageBase64 != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(captcha))
                    {
                        ...
                        NLogLogger.Info(new string[] { "UtilsGarena", tranId, tranId3rd, "DeCaptcha", "OK", cap[0] });
                        return cap[0];
                    }
                }
                return null;
            ...
            {
                NLogLogger.Info(new string[] { "UtilsGarena", "DeCaptcha", "Exception", e.Message });
                return null;
            }

        }
        public static async Task<GameCookie> PostTask(string url, string postData, CookieContainer cookieContainer, Dictionary<string, string> header = null)
        {
            var uri = new Uri(url);
            ...
            {
                NLogLogger.Info(new string[] { "UtilsGarena", "PostTask", "HttpRequestException", e.Message });
            }
            catch (TaskCanceledException e)
            {
                NLogLogger.Info(new string[] { "UtilsGarena", "PostTask", "TaskCanceledException", e.Message });
            ...
            {
                NLogLogger.Info(new string[] { "UtilsGarena", "PostTask", "WebException", e.Message });
            }
            catch (Exception e)
            {
                NLogLogger.Info(new string[] { "UtilsGarena", "PostTask", "Exception", e.Message });
            }
            //httpClient.Dispose();
            return null;
        ...
        public static async Task<GameCookie> GetTask(string url, CookieContainer cookieContainer)
        {
            ...
            {
                if (e.InnerException != null) NLogLogger.Info(new string[] { "UtilsGarena", "GetTask", "HttpRequestException", e.Message, e.InnerException.Message });
            }
            catch (TaskCanceledException e)
            {
                if (e.InnerException != null) NLogLogger.Info(new string[] { "UtilsGarena", "GetTask", "TaskCanceledException", e.Message, e.InnerException.Message });

            }
            catch (WebException e)
            {
                if (e.InnerException != null) NLogLogger.Info(new string[] { "UtilsGarena", "GetTask", "WebException", e.Message, e.InnerException.Message });

            }
            catch (Exception e)
            {
                if (e.InnerException != null) NLogLogger.Info(new string[] { "UtilsGarena", "GetTask", "Exception", e.Message, e.InnerException.Message });
            }
        ...
        public static GameCookie GetCookieCache(string sid)
        {
            ...
            {
                NLogLogger.Info(new string[] { "UtilsGarena", "GetCookieCache", "Exception", e.Message });
                return null;
            }
        }
        ...
        public static void SetCookieCache(string sid, GameCookie smasCookie)
        {
            ...
            {
                NLogLogger.Info(new string[] { "UtilsGarena", "SetCookieCache", "Exception", e.Message });
        ...
        //    catch (Exception e)
        //    {
        //        NLogLogger.Info(new string[] {"UtilsGarena", "SetTokenCache", "Exception", e.Message });
        //    }
        //}
        ...
        public static string GenSid(string accountName)
        {
            ...
            return "garena:" + accountName; // + ":" + tmp.ToLower(); //+ timeSpan.ToString();
        }
