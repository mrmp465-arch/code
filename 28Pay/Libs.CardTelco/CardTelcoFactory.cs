...
namespace Libs.CardTelco
{
    public static class CardTelcoFactory
    {
        ...
        static CardTelcoFactory()
        {
            ...
            //newCr7
            Register("ttpvtt", new VinaPay.VinaPayCard());
            Register("ttpvnp", new VinaPay.VinaPayCard());
            Register("ttpvms", new VinaPay.VinaPayCard());
            Register("ttpzing", new VinaPay.VinaPayCard());
            Register("ttpvcoin", new VinaPay.VinaPayCard());
            //vitetool
        ...
        public static void Register(string providerCode, ICardTelcoHandler hander)
        {
            ...
            switch (providerCode)
            {
                ...
                case "ttpvtt":
                    {
                        dicts.Add("ttpvtt", hander);
                        break;
                    }
                case "ttpvnp":
                    {
                        dicts.Add("ttpvnp", hander);
                        break;
                    }
                case "ttpvms":
                    {
                        dicts.Add("ttpvms", hander);
                        break;
                    }
                case "ttpzing":
                    {
                        dicts.Add("ttpzing", hander);
                        break;
                    }
                case "ttpvcoin":
                    {
                        dicts.Add("ttpvcoin", hander);
                        break;
                    }
                //case "shipvms":
                //    {
        ...
        public static ICardTelcoHandler GetHandler(string providerCode)
        {
            try
            {
                switch (providerCode)
                {
                    ...
                    case "ttpzing":
                        return dicts["ttpzing"];
                    case "ttpvcoin":
                        return dicts["ttpvcoin"];
