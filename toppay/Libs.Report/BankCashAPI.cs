...
namespace Libs.Report
{
    ...
    public class BankCashAPI
    {
        ...
        // Lấy danh sách
        public DataTable GetTable(int top, string partnerCodes, string Mobile, DateTime fromdate, DateTime requestTime, int? status, string bankCode, string refCode, long? amount = null, string ProviderCode = null,string orderInfo=null)
        {
