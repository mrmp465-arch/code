...
namespace Libs.Report
{
    public class Packet
    {
        ...
        public void Update()
        {
            ...
            pars[4] = string.IsNullOrEmpty(ProviderCode) ? new SqlParameter("@ProviderCode", DBNull.Value) : new SqlParameter("@ProviderCode", ProviderCode);
            pars[5] = NumberCard == null ? new SqlParameter("@NumberCard", DBNull.Value) : new SqlParameter("@NumberCard", NumberCard);
            pars[6] = NumberCardSole == null ? new SqlParameter("@NumberCardSole", DBNull.Value) : new SqlParameter("@NumberCardSole", NumberCardSole);
            pars[7] = NumberCardUp == null ? new SqlParameter("@NumberCardUp", DBNull.Value) : new SqlParameter("@NumberCardUp", NumberCardUp);
            pars[8] = IsActive == null ? new SqlParameter("@IsActive", DBNull.Value) : new SqlParameter("@IsActive", IsActive);
            pars[9] = ExpireDate == null ? new SqlParameter("@ExpireDate", DBNull.Value) : new SqlParameter("@ExpireDate", ExpireDate);
            pars[10] = CardValue == null ? new SqlParameter("@CardValue", DBNull.Value) : new SqlParameter("@CardValue", CardValue);
            pars[11] = string.IsNullOrEmpty(CardType) ? new SqlParameter("@CardType", DBNull.Value) : new SqlParameter("@CardType", CardType);
            pars[12] = Status == null ? new SqlParameter("@Status", DBNull.Value) : new SqlParameter("@Status", Status);
