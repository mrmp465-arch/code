...
namespace Libs.CardTelco.PayDirectCard.CHD
{
    public class PayDirectCard30 : ICardTelcoHandler
    {
        
        protected string providerName = "paydirect30";
        ...
        protected string ServiceUrl = "http://45.122.223.130/voucher/rest/useCard";
        protected string PartnerCode = "XBOM";
        protected string Password = "xbom@#$m!w";
        protected string SecretKey = "xbom@skr#";
