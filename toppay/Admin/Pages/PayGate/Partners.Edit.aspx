                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <div class="form-group">
                                        <label for="txtSMSCommand">Chiết khấu cố định (in) </label>
                                        <asp:TextBox ID="txtSMSCommand" runat="server" CssClass="form-control" placeholder="Chiết khấu cố định"></asp:TextBox>
                                    </div>
                                    <div class="form-group" >
                                        <label for="txtSMSPlusCheckUrl">Chiết khấu cố định (out)</label>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <asp:TextBox ID="txtSMSPlusCommand" runat="server" CssClass="form-control" placeholder="TeleGroupId"></asp:TextBox>
