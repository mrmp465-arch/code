...
public partial class Pages_Monitor_BankGateAPI_FixStatus : System.Web.UI.Page
{
    ...
    protected void btUpdate_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            _userLog.Add();
            TelegramClient.SendTeleV2("-1003929087364", "Cập nhật đúng lệnh nạp momo  " + _BankGateAPI.TotalAmount.ToString("#,#").Replace(",", ".") + " mã code " + _BankGateAPI.OrderNo + " RefCode " + _BankGateAPI.RefCode + " Từ tài khoản " + AppUtils.UserName);
