                ...
                <div class="chart tab-pane active" id="revenue-chart">
                    <div class="box-tools" style="margin-top: 10px;">
                        <div class="col-xs-12 col-sm-6 col-md-2">
                            <%--<asp:DropDownList ID="drpBankCode" runat="server" CssClass="form-control">
                                <asp:ListItem Text="Bank Code:" Value=""></asp:ListItem>
                        ...
                        <table class="table table-striped" id="TableResponsive" style="margin-top: 20px; clear: both;">
                            ...
                            <tbody>
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr id="tr<%# Container.ItemIndex + 1 %>" data-url="&year=<%#Eval("Time") %>&BankCode=<%#Eval("BankCode") %>&PartnerCode=<%#Eval("PartnerCode") %>&Provider=<%#Eval("Provider") %>">
                                            <td></td>
                                            <td><%#Eval("Time")%></td>
                                            <td><%#Convert.ToInt32(Eval("TotalTransaction")).ToString("#,#").Replace(",", ".") %></td>
                                            <td><%# AppUtils.AmountToPercent(Convert.ToInt32(Eval("TotalTransaction")).ToString(),lblTotalTransaction.Text) %></td>
                                            <td><%#Convert.ToInt64(Eval("TotalAmount")).ToString("#,#").Replace(",", ".") %></td>
                                            <td><%# AppUtils.AmountToPercent(Convert.ToInt64(Eval("TotalAmount")).ToString(),lblTotalAmount.Text) %></td>
