            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="txtRefCode">Trans Id</label>
                            <asp:TextBox ID="txtOrderInfo" runat="server" CssClass="form-control" placeholder="RefCode"></asp:TextBox>
                        </div>
                         <div class="form-group">
                            <label for="txtLogContent">Nội dung gốc </label>
                            <asp:TextBox ID="txtAccountName" runat="server" ReadOnly="true" CssClass="form-control" placeholder="Ghi chú"></asp:TextBox>
                        </div>
                         <div class="form-group">
                            <label for="txtLogContent">Nội dung cập nhật </label>
                            <asp:TextBox ID="txOrderNo" runat="server" CssClass="form-control" placeholder="Ghi chú"></asp:TextBox>
                        </div>
                        <div class="checkbox">
                            <label for="cbxIsActive">
                                <asp:CheckBox ID="cbxAddOCRDictionary"  runat="server"></asp:CheckBox>Add OCR Dictionary
                            </label>
                        </div>
                    </div>
                    <div class="col-md-6">
