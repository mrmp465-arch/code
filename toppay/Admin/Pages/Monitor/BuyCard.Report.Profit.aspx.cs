...
public partial class Pages_Monitor_BuyCard_Report_Profit : System.Web.UI.Page
{
    ...
    private void GetList()
    {
        ...
        BuyCard _BuyCardLog = new BuyCard();
        NLogLogger.Info(new string[] { partnerCodes, cardType, providerCodes });
        rptList.DataSource = _BuyCardLog.ReportProfit(partnerCodes, cardType, providerCodes, year, month, day, ref totalTransaction, ref totalAmount, ref totalProfit);
