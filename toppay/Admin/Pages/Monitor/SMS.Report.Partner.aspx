<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="SMS.Report.Partner.aspx.cs" Inherits="Pages_Monitor_SMS_Report_Partner" %>
    ...
    <section class="content">
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
                ...
                <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.SMSReportCardType %>">Theo đầu số</a></li>
                <%if (AppUtils.IsAdmin)
                    {%>
                <li class="active"><a href="#revenue-chart" data-toggle="tab">Theo đối tác</a></li>
                ...
                <div class="chart tab-pane active" id="revenue-chart">
                    <div class="box-tools" style="margin-top: 10px;">
                        <div class="col-xs-12 col-sm-4 col-md-2">
                            <asp:DropDownList ID="drpReceiverNumber" runat="server" CssClass="form-control">
                        ...
                        <table class="table table-striped" id="TableResponsive" style="margin-top: 20px; clear: both;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">ReceiverNumber</th>
                            ...
                            <tbody>
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr class="trId<%#Eval("PartnerCode") %> <%#Eval("TrClass") %>  tr<%#Eval("Row") %> closes" data-id="<%#Eval("PartnerCode") %>">
                                            <td style="padding: 15px 0 15px 0; width: 0 !important;"></td>
                                            <td class="td0"><%#Eval("STT") %></td>
                                            <td style="text-align: center;" class="td1 clicktd"><%#Eval("Partner") %></td>
                                            <td class="clicktd" style="text-align: center;"><%#Eval("ReceiverNumber") %></td>
                                            ...
                                            <td class="clicktd"><span style="padding-left: 30%;"><%#Convert.ToInt64(Eval("TotalAmount")).ToString("N0").Replace(",", ".") %></span></td>
