...
public partial class Pages_Topup_Report : System.Web.UI.Page
{ 
    protected void Page_Load(object sender, EventArgs e)
    {
        AppUtils.CheckRoles(Resources.Url.TopupReport);
    ...
    {  
        ...
        rptList.DataSource = new TopupMobileTransactionLog().Report(UserIds, txtTelco.SelectedValue,  year, month, day, ref totalTransaction, ref totalAmount);
    ...
    {
        if (!string.IsNullOrEmpty(txtUsers.SelectedValue))
            return txtUsers.SelectedItem.Text;
        else
            return "";
    }
    public string GetTelco()
    {
        if (!string.IsNullOrEmpty(txtTelco.SelectedValue))
            return txtTelco.SelectedItem.Text;
        else
            return "";
    }
