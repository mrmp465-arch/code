<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="Topup.Sim.Edit.aspx.cs" Inherits="Pages_PayGate_Topup_Sim_Edit" %>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><%=DeviceName%> - Slot <%=Slot%></h3>
            </div>
