                ...
                <div class="box" runat="server" id="dvNap">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary pull-right" OnClick="btAdd_Click2"  OnClientClick="return confirm('Bạn có chắc muốn tạo lệnh?');" Text="Tạo lệnh"></asp:Button>
