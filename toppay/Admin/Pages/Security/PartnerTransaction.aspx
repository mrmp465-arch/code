            ...
            <div class="col-xs-12">
                ...
                <div class="box" id="dvRut" runat="server">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="drpBankCode" runat="server" CssClass="form-control select2">
                                        ...
                                        <asp:ListItem Value="usdt-erc20">usdt-erc20</asp:ListItem>
                    ...
                    <div class="box-footer">
                        <asp:Button ID="btCreate" runat="server" CssClass="btn btn-primary pull-right" OnClick="btAdd_Click"  OnClientClick="return confirm('Bạn có chắc muốn tạo lệnh rút tiền không?');"  Text="Tạo lệnh rút tiền"></asp:Button>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="txtDescription"><%= Resources.Pay.AccountNumber%>*</label>
                                    <asp:TextBox ID="txtAccountNumber2" runat="server" CssClass="form-control" placeholder=""></asp:TextBox>

                                </div>
                                <div class="form-group">
                                    <label for="txtDescription"><%= Resources.Pay.AccountName%>*</label>
                                    <asp:TextBox ID="txtAccountName2" runat="server" CssClass="form-control" placeholder=""></asp:TextBox>
                        ...
                        <div style="padding-right: 15px">
                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary pull-right" OnClick="btAdd_Click2"   OnClientClick="return confirm('Bạn có chắc muốn tạo lệnh rút tiền không?');"  Text="Tạo lệnh rút tiền"></asp:Button>
