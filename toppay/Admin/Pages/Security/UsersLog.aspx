                    ...
                    <div class="box-tools" style="margin-top: 10px;">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2">
                            ...
                            <asp:DropDownList ID="drpType" runat="server" CssClass="form-control select2">
                                ...
                                <asp:ListItem Text="Cập nhất chiếu khấu" Value="partnereditck"></asp:ListItem>
                                <asp:ListItem Text="Cấu hình hệ thống" Value="systemconfig"></asp:ListItem>
                                <asp:ListItem Text="Cập nhật nhập khoản" Value="bankinupdate"> </asp:ListItem>
                                <asp:ListItem Text="Hủy xuất khoản" Value="bankoutcancel"></asp:ListItem>
                                <asp:ListItem Text="Duyệt tay xuất khoản" Value="bankoutapp"></asp:ListItem>
