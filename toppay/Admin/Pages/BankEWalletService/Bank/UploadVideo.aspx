                        ...
                        <div class="tab-content">
                            <div class="chart tab-pane active" id="account-video">
                                <div class="box">
                                    ...
                                    <h2><asp:Label runat="server" ID="lblBankInfo"></asp:Label></h2>
                                    <div style="display:none"> <asp:Label runat="server" ID="lblId" Visible="true"></asp:Label></div>
                                    ...
                                    <asp:Button ID="btnUpload" runat="server" Visible="false"
                                        Text="Upload"
