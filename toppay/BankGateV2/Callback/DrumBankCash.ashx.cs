...
{
    /// <summary>
    /// Summary description for DrumCash
    /// </summary>
    public class DrumBankCash : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                var callbackdata = serializer.Deserialize<DrumBankLib.BankResponse>(jsonString);
                ...
                var callback = new DrumV2Bank().Callback(callbackdata);
