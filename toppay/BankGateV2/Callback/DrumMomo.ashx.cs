...
namespace BankGateV2.Callback
{
    ...
    /// </summary>
    public class DrumMomo : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                NLogLogger.Info(new string[] { "MDrumMOMOCalback", "ProcessRequest", jsonString });
                ...
                //NLogLogger.Info(new string[] { "MDrumCalbackV3", "ProcessRequest", serializer.Serialize(newclObj) });
