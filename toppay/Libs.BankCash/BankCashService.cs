    ...
    public class BankCashService : IServiceHandler
    {
        ...
        private APIResponse Cash(APITransaction transaction)
        {
            ...
            try
            {
                ...
                //    {
                //        TelegramNotify.SendTeleV2("-5063693305", "[Out Litmit] Vượt hạn mức rút từ đối tác " + transaction.PartnerCode + "(" + total.ToString("#,#").Replace(",", ".") + "-" + total2.ToString("#,#").Replace(",", ".")  +" Refcode "+request.RefCode + ")");
