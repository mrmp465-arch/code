...
namespace Libs.API
{
    ...
    public class Partners
    {
        ...
        public long BalanceHold { get; set; }
        ...
        public int Topup(long Amount,string Code,string Data="")
        {
            DBHelper db = new DBHelper(Configs.VPGAPIConnectionStrings);
        ...
        public int Deduct(long Amount, string Code, string Data = "")
        {
            DBHelper db = new DBHelper(Configs.VPGAPIConnectionStrings);
            SqlParameter[] pars = new SqlParameter[4];
            pars[0] = new SqlParameter("@ReturnValue", SqlDbType.Int) { Direction = ParameterDirection.Output };
        ...
        public int TopupHold(long Amount, string Code, string Data = "")
        {
            DBHelper db = new DBHelper(Configs.VPGAPIConnectionStrings);
            SqlParameter[] pars = new SqlParameter[4];
            pars[0] = new SqlParameter("@ReturnValue", SqlDbType.Int) { Direction = ParameterDirection.Output };
            ...
            pars[2] = new SqlParameter("@PartnerCode", Code);
            pars[3] = new SqlParameter("@Data", Data);
            db.ExecuteNonQuerySP("sp_PartnersTopupHold", pars);
            return Convert.ToInt32(pars[0].Value);
        }
        public int DeductHold(long Amount, string Code, string Data = "")
        {
            DBHelper db = new DBHelper(Configs.VPGAPIConnectionStrings);
            SqlParameter[] pars = new SqlParameter[4];
            pars[0] = new SqlParameter("@ReturnValue", SqlDbType.Int) { Direction = ParameterDirection.Output };
            ...
            pars[2] = new SqlParameter("@PartnerCode", Code);
            pars[3] = new SqlParameter("@Data", Data);
            db.ExecuteNonQuerySP("sp_PartnersDeductHold", pars);

            return Convert.ToInt32(pars[0].Value);
        }
        public int DeductConfirm(long Amount, string Code, string Data = "")
        {
            DBHelper db = new DBHelper(Configs.VPGAPIConnectionStrings);
            SqlParameter[] pars = new SqlParameter[4];
            pars[0] = new SqlParameter("@ReturnValue", SqlDbType.Int) { Direction = ParameterDirection.Output };
            ...
            pars[2] = new SqlParameter("@PartnerCode", Code);
            pars[3] = new SqlParameter("@Data", Data);
            db.ExecuteNonQuerySP("sp_PartnersDeductConfirm", pars);
