...
namespace BankGateV2
{
    ...
    /// </summary>
    public class GetBankV3 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                var request = javaScriptSerializer.Deserialize<RequestGetBank>(jsonString);
                //NLogLogger.Info(new string[] { "VPGJsonService", "Request", jsonString });
                result = VPGUtils.RequestMomo(request.MCode, request.RequestTime, "banktranfer", request.Signature);
            }
            catch (Exception exp)
            {
