...
namespace BankGateV2
{
    ...
    /// </summary>
    public class UsdtRequest : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = VPGUtils.Order(request.PartnerCode, request.Amount, request.RefCode, request.BankCode, request.CallbackUrl, request.AccountName, request.Signature, type);
            }
            catch (Exception exp)
            {
