...
namespace APIAloPay
{
    ...
    public class CardCallback : IHttpHandler
    {
        ...
        {
            NLogLogger.Info(new string[] { "APIAloPay", "Callback Partner", "Request", code, url, postData });
            ...
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    if (response.Content != null)
                    {
                        ...
                        NLogLogger.Info(new string[] { "APIAloPay", "Callback Partner", "Response", code, url, postData, responseContent });
            ...
            {
                NLogLogger.Info(new string[] { "APIAloPay", "Callback Partner", "Error", e.Message });
                return string.Empty;
            }
