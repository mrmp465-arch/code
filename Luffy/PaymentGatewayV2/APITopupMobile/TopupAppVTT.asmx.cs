...
namespace APITopupMobile
{
    ...
    public class TopupAppVTTService : System.Web.Services.WebService
    {
        ...
        {
            NLogLogger.Info(new string[] { "TopupAppVTTService", transactionId,telco, partnerCode, providerCode, cardSerial, cardCode, amount.ToString() });
            if (telco.ToUpper() == "VTT")
            {
                var result = new TopupAppVTT().SendAppVTTTopup(transactionId, telco, partnerCode, providerCode, cardSerial, cardCode, amount);
