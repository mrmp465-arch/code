...
namespace Libs.BankDirect.M32
{
    public class M32BankLib
    {
        ...
        public static async Task<string> PostTask(string url, string postData)
        {
            ...
            {
                NLogLogger.Info(new string[] { "M32", "Exeption Post", e.Message });
                return string.Empty;
            }
            client.Dispose();
            return string.Empty;
        ...
        public static async Task<string> GetTask(string url)
        {
            ...
            NLogLogger.Info(new string[] { "M32", "GetTask", url });
            ...
            {
                NLogLogger.Info(new string[] { "M32", "GetTask", "Exception", url, e.Message });
            }
            client.Dispose();
            return string.Empty;
        }
        ...
        public static async Task<string> CallbackJson(string url, string postData)
        {
            ...
            NLogLogger.Info(new string[] { "M32", "Callback", "Partner", "Request", postData, url });
            var uri = new Uri(url);
            var httpContent = new StringContent(postData, Encoding.UTF8, "application/json");
            httpContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
            ...
            try
            {
                ...
                if (response.Content != null)
                {
                    ...
                    NLogLogger.Info(new string[] { "M32", "Callback", "Partner", "Response", responseContent });
                    client.Dispose();
                    return responseContent;
                }
            ...
            catch (WebException e)
            {
                ...
                if (responseStream != null)
                {
                    ...
                    {
                        NLogLogger.Info(new string[] { "M32", "Exeption Post", reader.ReadToEnd() });
                        //return result;
                    }
                }
                NLogLogger.Info(new string[] { "M32", "Exeption Post", e.Message });
