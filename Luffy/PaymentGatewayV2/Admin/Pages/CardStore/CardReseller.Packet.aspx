        ...
        <table class="table table-striped">
            ...
            <tr class="item-tr2 item-tr2-<%#Eval("Id") %>" data-id="<%#Eval("Id") %>" data-open="false" data-page="1">
                ...
                <td class="NumberCardSole">
                    <input type='text' style="display: none; width: 70px;" value="<%#Eval("NumberCardSole") %>" /><span><%#Eval("NumberCardSole") %></span> </td>
                <td class="NumberCardUp">
                        <input type='text' style="display: none; width: 70px;" value="<%#Eval("NumberCardUp") %>" /><span><%#Eval("NumberCardUp") %></span> </td>
                <td class="CardValue">
