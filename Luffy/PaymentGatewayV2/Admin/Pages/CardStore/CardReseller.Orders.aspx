...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server"> 
    ...
    <script type="text/javascript"> 
        ...
        function blockPack(PackId, display1, display2, IsAdd) {
            $(".item-tr2-" + PackId + " .Name input" + ",.item-tr2-" + PackId + " .Provider select,.item-tr2-" + PackId + " .NumberCard input" + ",.item-tr2-" + PackId + " .NumberCardSole input" + ",.item-tr2-" + PackId + " .NumberCardUp input" + ",.item-tr2-" + PackId + " .ExpireDate input" + ",.item-tr2-" + PackId + " .CardValue input" + ",.item-tr2-" + ",.item-tr2-" + PackId + " .ProviderCode select" + ",.item-tr2-" + PackId + " .CardType select" + ",.item-tr2-" + PackId + " .Status select" + ",.item-tr2-" + PackId + " .IsActive select").css("display", display1);
            $("select option").each(function (index) {
                if ($(this).val() == $(this).data("value")) { $(this).attr("selected", "selected"); }
            });

            $(".item-tr2-" + PackId + " .Name span" + ",.item-tr2-" + PackId + " .Provider span,.item-tr2-" + PackId + " .NumberCard span" + ",.item-tr2-" + PackId + " .NumberCardSole span" + ",.item-tr2-" + PackId + " .NumberCardUp span" +",.item-tr2-" + PackId + " .ExpireDate span" + ",.item-tr2-" + PackId + " .CardValue span" + ",.item-tr2-" + PackId + " .ProviderCode span" + ",.item-tr2-" + PackId + " .CardType span" + ",.item-tr2-" + PackId + " .Status span" + ",.item-tr2-" + PackId + " .IsActive span" ).css("display", display2);
