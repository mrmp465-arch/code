<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="Users.Add.aspx.cs" Inherits="Pages_Topup_Users_Add" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>Tài Khoản
        <small><a href="<%=Constant.ADMIN_PATH %><%=Resources.Url.TopupUsersList %>">Thêm thông tin tài khoản</a>
        </small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="nav-tabs-custom">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12" style="padding-bottom: 10px;">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <asp:CheckBox ID="cbxIsCheck" runat="server" Checked='<%#Eval("IsCheck") %>'></asp:CheckBox>
                                            <asp:HiddenField ID="txtProviderId" Value='<%#Eval("ProviderId") %>' runat="server"></asp:HiddenField>
            ...
            <div class="box-footer">
                <asp:Button ID="btAdd" runat="server" Text="Thêm Mới " CssClass="btn btn-primary " OnClick="btAdd_Click"></asp:Button>
