<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="Topup.Report.Telco.aspx.cs" Inherits="Pages_Topup_Report_Telco" %>
    ...
    <section class="content">
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
                ...
                <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.TopupReportOrder %>">Theo Order</a></li>
            </ul>
                        ...
                        <table class="table table-striped" id="TableResponsive" style="margin-top: 20px; clear: both;">
                            ...
                            <tbody>
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr id="tr<%# Container.ItemIndex + 1 %>" data-url="&CardType=<%#Eval("Telco") %>&UserId=<%#Eval("UserId") %> %>">
                                            <td></td>
                                            <td><%#Eval("Telco") %></td>
