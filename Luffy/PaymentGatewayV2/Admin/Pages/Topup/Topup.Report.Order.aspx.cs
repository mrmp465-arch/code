...
public partial class Pages_Topup_Report_Order : System.Web.UI.Page
{ 

    protected void Page_Load(object sender, EventArgs e)
    {
        AppUtils.CheckRoles(Resources.Url.TopupReportOrder);
    ...
    private void GetList()
    {
        ...
        rptList.DataSource = new TopupMobileTransactionLog().ReportOrder(UserIds, txtTelCo.SelectedValue, year, month, day, ref totalTransaction, ref totalAmount);;
