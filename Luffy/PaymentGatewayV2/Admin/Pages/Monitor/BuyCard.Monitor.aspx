<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="BuyCard.Monitor.aspx.cs" Inherits="Pages_Monitor_BuyCard_Monitor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>Mua thẻ & Topup
            <small>
                <asp:Label ID="lblTtitle" runat="server" Text="Xem log mua mã thẻ" CssClass="title"></asp:Label>
            </small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <asp:Label runat="server" Text="Xem log mua mã thẻ" CssClass="title"></asp:Label></h3>
                    </div>
                    <div class="box-tools" style="margin-top: 10px;">
                        ...
                        <style type="text/css">
                            .DivStatus {position:relative;} 
                            .DivStatus .lb {position: absolute;display: none; left: 0;top: 33px;z-index: 10000;background: #1e90ff;border: 1px solid #7b9dd4;width: 100%;padding: 3px 0 3px 54px;color: #FFF;}
                        </style>
