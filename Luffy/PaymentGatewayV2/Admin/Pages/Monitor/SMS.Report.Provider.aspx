<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="SMS.Report.Provider.aspx.cs" Inherits="Pages_Monitor_SMS_Report_Provider" %>
                        ...
                        <table class="table table-striped" id="TableResponsive" style="margin-top: 20px; clear: both;">
                            ...
                            <tbody>
                                ...
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr class="trId<%#Eval("ProviderCode") %> <%#Eval("TrClass") %> tr<%#Eval("Row") %> closes" data-id="<%#Eval("Provider") %>">
                                            <td style="padding: 15px 0 15px 0; width: 0 !important;"></td>
                                            <td class="td0"><%#Eval("STT") %></td>
                                            <td style="text-align: center;" class="td1 clicktd"><%#Eval("Provider") %></td>
