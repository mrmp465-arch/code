                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="txtOrderNo">OrderInfo</label>
                            <asp:TextBox ID="txtOrderInfo" runat="server" CssClass="form-control" placeholder="OrderInfo" ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtRefCode" runat="server" CssClass="form-control" placeholder="RefCode"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label for="txtRefCode">Partner</label>
