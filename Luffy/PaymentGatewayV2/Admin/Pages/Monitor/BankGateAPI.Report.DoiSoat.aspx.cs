...
public partial class Pages_Monitor_BankGateAPI_Report_DoiSoat : System.Web.UI.Page
{
        ...
        private void init()
    {
        ...
        drpPartner1.Items.Insert(0, new System.Web.UI.WebControls.ListItem("Đối tác:", ""));
    ...
    private void GetList1()
    {
        ...
        lstReportDoiSoat1 = _BankGateAPI.ReportDoiSoat(partnerCodes, providerCodes, bankCode, beginTime, endTime, 1);
    }
