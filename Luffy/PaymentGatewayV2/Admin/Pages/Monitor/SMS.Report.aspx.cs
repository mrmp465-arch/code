...
public partial class Pages_Monitor_SMS_Report : System.Web.UI.Page
{
    ...
    private void GetList()
    {
        ...
        if (month == 0) day = 0;
        rptList.DataSource = new MessageIn().Report(partnerCodes, provider, cardType, year, month, day, ref totalTransaction, ref totalAmount);
    ...
    {
        Response.Redirect(Constant.ADMIN_PATH + Resources.Url.SMSReportCardType);
    }

    protected void btProvider_Click(object sender, EventArgs e)
    {
        Response.Redirect(Constant.ADMIN_PATH + Resources.Url.SMSReportProvider);
    }
