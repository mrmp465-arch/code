...
public partial class Pages_Monitor_BankCash_Report_Partner : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        AppUtils.CheckRoles(Resources.Url.BankCashReportPartner);
    ...
    private void GetList()
    {
        ...
        rptList.DataSource = _BankCash.ReportPartner(bankCode, partnerCodes, year, month, day, ref totalTransaction, ref totalAmount);
