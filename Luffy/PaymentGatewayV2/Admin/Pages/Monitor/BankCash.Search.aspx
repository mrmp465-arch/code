<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="BankCash.Search.aspx.cs" Inherits="Pages_Monitor_BankCash_Search" %>
                                ...
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Eval("RefCode") %></td>
                                            <td><%#Eval("BankCode") %></td>
                                            <td><%#Eval("BankAccountName") %></td>
                                            <td><%#Eval("BankAccountNumber")%></td>
                                            
                                            <td><%#Convert.ToDecimal(Eval("Amount")) %></td>
                                            ...
                                            <td><%#Eval("Status") %></td>
                                            <td><a href="<%=Constant.ADMIN_PATH + Resources.Url.BankCashMonitorDetail%>?id=<%#Eval("TransactionID") %>">xem</a></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </tbody>
