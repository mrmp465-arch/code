    ...
    protected void btAdd_Click(object sender, EventArgs e)
    {
        ...
        if (LstPartners != null)
        {
            ...
            for (int i = 0; i < rptList.Items.Count; i++)
            {
                ...
                HiddenField txtPartnerId = (HiddenField)rptList.Items[i].FindControl("txtPartnerId");
                HiddenField txtPartnerCode = (HiddenField)rptList.Items[i].FindControl("txtPartnerCode");
