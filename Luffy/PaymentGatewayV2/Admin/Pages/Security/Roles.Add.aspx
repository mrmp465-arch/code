                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="txtGoup" runat="server" OnSelectedIndexChanged="txtGoup_SelectedIndexChanged" CssClass="form-control" AutoPostBack="True">
                                ...
                                <asp:ListItem Value="3">Mua thẻ & Topup</asp:ListItem>
                                <asp:ListItem Value="4">Ngân hàng</asp:ListItem>
                                 <asp:ListItem Value="5">Ngân hàng-Cash</asp:ListItem>
                                <asp:ListItem Value="6">SMS</asp:ListItem>
                                <asp:ListItem Value="7">Kho thẻ</asp:ListItem>
                                 <asp:ListItem Value="8">USSD</asp:ListItem>
                                ...
                                <asp:ListItem Value="12">Biến động số dư</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
