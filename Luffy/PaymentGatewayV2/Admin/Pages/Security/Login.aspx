<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Pages_Security_Login" %>
    ...
    <form id="form1" runat="server">
        <div class="login-box">
            <div class="login-logo">
                <a href="<%=Constant.ADMIN_PATH %>"><b>Luffy</b>Gate</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <div class="row" style="padding: 20PX 0 25PX;">
                    ...
                    <!-- /.col -->
                    <div class="col-xs-4">
                        <asp:Button ID="btSignIn" runat="server" CssClass="btn btn-primary btn-block btn-flat" Text="Đăng nhập" OnClick="btSignIn_Click"></asp:Button>
                    </div>
                    <!-- /.col -->
                </div>
