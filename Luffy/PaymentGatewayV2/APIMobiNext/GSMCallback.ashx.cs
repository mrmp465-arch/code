                ...
                if (messageDb != null)
                {
                    ...
                    switch (resObj.Status)
                    {
                        ...
                        case (int)ResponseCode.ServiceIsLocked:
                            ...
                            TelegramNotify.SendNotify(messageDb.ProviderCode, topupProcess.Mobile, topupProcess.Telco, topupProcess.Amount, 2);
                    ...
                    if (resultUpdate == 0)
                    {
                        ...
                        if (topupProcess.AmountTopupSuccess + amountReal >= topupProcess.Amount)
                        {
                            ...
                            TelegramNotify.SendNotify(messageDb.ProviderCode, topupProcess.Mobile, topupProcess.Telco, topupProcess.Amount, 4);
