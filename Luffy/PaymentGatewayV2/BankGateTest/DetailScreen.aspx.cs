...
{
    public partial class DetailScreen : System.Web.UI.Page
    {
        protected async void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(orderNo) && !string.IsNullOrEmpty(refcode) && !string.IsNullOrEmpty(chatid) )
                {
                  ...
                  botToken: "123456:ABC...",
                  chatId: chatid,
                  url: "https://info.5apps.info/Pages/Detail.aspx?orderNo=" + orderNo,
                  billSelector: "#bill", 
       ...
       string url,
       string billSelector,  
       string message_id , // ví dụ: "#bill", ".bill-container", "#ctl00_ContentPlaceHolder1_bill"
       string caption )
            {
                    ...
                    Args = new[]
      {
        ...
        "--user-data-dir=C:\\chrome-profile"
            ...
            {
                var apiUrl = "https://api.telegram.org/bot8010825769:AAEbExMZtB9twOsAb8uyjM6noeWfWlPm5yg/sendPhoto";
