...
{
    public partial class DetailScreen3 : System.Web.UI.Page
    {
        protected async void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(orderNo) && !string.IsNullOrEmpty(refcode) && !string.IsNullOrEmpty(chatid))
                {
                  ...
                  botToken: "123456:ABC...",
                  chatId: chatid,
                  url: "https://info.28app.info/Pages/Detail.aspx?orderNo=" + orderNo,
                  billSelector: "#bill",
                    ...
                    Args = new[]
      {
        ...
        "--user-data-dir=C:\\chrome-profile"
            ...
            {
                var apiUrl = "https://api.telegram.org/bot8605707960:AAFl2eXsuqMvMk3KVo7JyK2b9iaLQKj8AFI/sendPhoto";
