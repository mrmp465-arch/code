...
{
    public partial class DetailScreen10 : System.Web.UI.Page
    {
        protected async void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(orderNo) && !string.IsNullOrEmpty(refcode) && !string.IsNullOrEmpty(chatid))
                {
                  ...
                  botToken: "123456:ABC...",
                  chatId: chatid,
                  url: "https://info.666app.info/Pages/Detail.aspx?orderNo=" + orderNo,
                  billSelector: "#bill",
                    ...
                    Args = new[]
      {
        ...
        "--user-data-dir=C:\\chrome-profile"
            ...
            {
                var apiUrl = "https://api.telegram.org/bot8863680048:AAFM5JHb_6au3CAlwXX38XlZv9OXn8xLlWg/sendPhoto";
