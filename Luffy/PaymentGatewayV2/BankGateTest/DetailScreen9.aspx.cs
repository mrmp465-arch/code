...
{
    public partial class DetailScreen9 : System.Web.UI.Page
    {
        protected async void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(orderNo) && !string.IsNullOrEmpty(refcode) && !string.IsNullOrEmpty(chatid))
                {
                  ...
                  botToken: "123456:ABC...",
                  chatId: chatid,
                  url: "https://info.sdapp.org/Pages/Detail.aspx?orderNo=" + orderNo,
                  billSelector: "#bill",
                    ...
                    Args = new[]
      {
        ...
        "--user-data-dir=C:\\chrome-profile"
            ...
            {
                var apiUrl = "https://api.telegram.org/bot8881845685:AAHUx2_QaWyiFaNoC0N5w-dles0_qeBuMlU/sendPhoto";
