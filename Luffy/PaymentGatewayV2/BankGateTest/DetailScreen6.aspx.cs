...
{
    public partial class DetailScreen6 : System.Web.UI.Page
    {
        protected async void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(orderNo) && !string.IsNullOrEmpty(refcode) && !string.IsNullOrEmpty(chatid))
                {
                  ...
                  botToken: "123456:ABC...",
                  chatId: chatid,
                  url: "https://momo.opaps.info/Pages/Detail.aspx?orderNo=" + orderNo,
                  billSelector: "#bill",
                  caption: refcode 
              );
                }
                    ...
                    Args = new[]
      {
        ...
        "--user-data-dir=C:\\chrome-profile"
            ...
            {
                var apiUrl = "https://api.telegram.org/bot8351377347:AAGUeBCSu7PwC65mVMHAsSDt8no-poAKqvo/sendPhoto";
