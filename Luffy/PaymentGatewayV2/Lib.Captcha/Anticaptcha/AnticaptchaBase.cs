...
namespace Lib.Captcha.Anticaptcha
{
    public abstract class AnticaptchaBase
    {
        ...
        public abstract JObject GetReportIncorrectImagePostData();
        ...
        public bool ReportIncorrectImage()
        {
            //var requestJson = GetReportIncorrectImagePostData();
            //if (requestJson == null)
            //{
            //    DebugHelper.Out("A task preparing error.", DebugHelper.Type.Error);
            ...
            DebugHelper.Out("Connecting to " + Host, DebugHelper.Type.Info);
            dynamic postResult = JsonPostRequest(ApiMethod.ReportIncorrectImageCaptcha, jsonPostData);
            ...
            var response = new ReportIncorrectImageCaptchaResponse(postResult);
        ...
        public bool WaitForResult(int maxSeconds = 200, int currentSecond = 0) // default 120s
        {
