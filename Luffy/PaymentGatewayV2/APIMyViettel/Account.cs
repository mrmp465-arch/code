...
namespace APIMyViettel
{
    public class Account
    {
        ...
        public void Update()
        {
            ...
            db.ExecuteNonQuerySP("sp_MyVTTAccount_Update", pars);
        ...
        public long Insert()
        {
            ...
            db.ExecuteNonQuerySP("sp_MyVTTAccount_Insert", pars);
            ReturnValue = Convert.ToInt64(pars[0].Value);
            return ReturnValue;
        }
        public long InsertReview()
        {
            ...
            db.ExecuteNonQuerySP("sp_MyVTTAccount_InsertReview", pars);
            ReturnValue = Convert.ToInt64(pars[0].Value);
            return ReturnValue;
        }
        ...
        {
            DBHelper db = new DBHelper(Configs.CaptChaConnectionStrings);
            return db.GetInstanceSP<Account>("sp_Get_AccountVTT", new SqlParameter("@Type", type));
        }

        public Account GetAccountCheck(int type)
        {
            DBHelper db = new DBHelper(Configs.CaptChaConnectionStrings);
            return db.GetInstanceSP<Account>("sp_Check_AccountVTT", new SqlParameter("@Type", type));
        }
