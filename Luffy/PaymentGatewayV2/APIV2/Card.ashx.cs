    ...
    public class Card : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = VPGUtils.RequestV2(request.PartnerCode, request.CardCode, request.CardSerial, request.Amount,request.CardType, request.AccountName,request.RefCode,request.CallbackUrl, request.Signature);
            }
            catch (Exception exp)
            {
