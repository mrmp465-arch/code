...
namespace APIV2
{
    ...
    /// </summary>
    public class CardV3 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                result = VPGUtils.RequestV2(request.MCode, request.CardCode, request.CardSerial, request.Amount, request.CardType, request.RefCode, request.RefCode, request.CallbackUrl, request.Signature);
            }
            catch (Exception exp)
            {
