...
namespace WService
{
    partial class FailOverProcess : ServiceBase
    {
        private FailOverService failOverService = new FailOverService();

        public FailOverProcess()
        {
            InitializeComponent();

            failOverService.StartProcessFailOver();
        }
