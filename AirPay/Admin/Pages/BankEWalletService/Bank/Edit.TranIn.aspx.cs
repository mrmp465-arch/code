...
public partial class Pages_BankEWalletService_Bank_Edit_TranIn : System.Web.UI.Page
{
    ...
    protected void btnEditTran_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            _userLog.Add();
            TelegramClient.SendTeleV2("-5110278047", "Cập nhật nội dung giao dịch bank " + _bankTranLog.Id + " | " + _bankTranLog.Comment + " | " + _bankTranLog.Amount.GetValueOrDefault().ToString("#,#").Replace(",", ".") + " Từ tài khoản " + AppUtils.UserName);
