...
namespace APIMyMobi
{
    public class Account
    {
        ...
        public void Update()
        {
            ...
            db.ExecuteNonQuerySP("sp_MyVMSAccount_Update", pars);
        ...
        public long Insert()
        {
            ...
            db.ExecuteNonQuerySP("sp_MyVMSAccount_Insert", pars);
            ReturnValue = Convert.ToInt64(pars[0].Value);
            return ReturnValue;
        }
        ...
        {
            DBHelper db = new DBHelper(Configs.CaptChaConnectionStrings);
            return db.GetInstanceSP<Account>("sp_Get_AccountVMS", new SqlParameter("@AccountName", accountName));
        }
