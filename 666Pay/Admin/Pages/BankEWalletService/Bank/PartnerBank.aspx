<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartnerBank.aspx.cs" MasterPageFile="~/Layout/Layout.master" Inherits="Pages_BankEWalletService_Bank_PartnerBank" %>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box-tools" style="margin-top: 10px;">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2">
                            <div class="input-group">
                                <span class="input-group-addon" style="padding: 5px;">Bank Account</span>
                                ...
                                <asp:Repeater ID="rptList" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%#Eval("BankCode") %></td>
                                            <td><%#Eval("BankId") %></td>
                                            <td><a href="<%=Constant.ADMIN_PATH %><%=Resources.Url.BankAccountEdit %>?id=<%#Eval("BId") %>"><%#Eval("BankName") %></a></td>
                    ...
                    <div class="box-footer">
                        ...
                        <asp:Button ID="btUpdate" runat="server" Text="Update" CssClass="btn btn-info pull-right " OnClick="btApply_Click"></asp:Button>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
