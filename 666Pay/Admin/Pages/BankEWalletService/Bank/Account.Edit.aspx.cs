...
public partial class Pages_BankEWalletService_Bank_Account_Edit : System.Web.UI.Page
{
    ...
    private void init()
    {
        ...
        if (_bank.BankCode == "SEAB" || _bank.BankCode == "ACB" || _bank.BankCode == "VPB")
        {
            ...
            string UploadFolderPhysical = Path.Combine(@"Z:\666PAY", bankCode, bankId);
    ...
    protected void btnCashForm4_Click(object sender, EventArgs e)
    {
        ...
        if (resObj != null)
        {
            ...
            if (resObj.ResponseCode == (int)ResponseCode.TransactionSuccessful)
            {
                ...
                TelegramClient.SendTeleV2("-5569640045", "Chuyển tiền bank " + drpBankCode.SelectedValue + " | " + txtBankId.Text + " | " + txtAmountForm4.Text + " |" + drpBankCodeForm4.SelectedValue + " | " + txtBankIdForm4.Text +" từ user " + AppUtils.UserName );
                _userLog.Add();
            }
