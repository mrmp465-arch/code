<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="Check.TranOut.aspx.cs" Inherits="Pages_BankEWalletService_Bank_TranOut" %>
        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                <dl class="dl-horizontal">
                    ...
                    <dt>Bank hệ thống</dt>
                    <dd>
                        <asp:Label ID="lblPartnerBankCode" runat="server" Text=""></asp:Label> (<asp:Label ID="lblPartnerBankName" runat="server" Text=""></asp:Label>)</dd>
                    <dt>Tk Dịch Vụ</dt>
                    <dd>
                        <asp:Label ID="lblPartnerBankId" runat="server"></asp:Label></dd>
                    <dt>Bank Khách</dt>
                    <dd>
                        <asp:Label ID="lblBankCode" runat="server" Text=""></asp:Label> (<asp:Label ID="lblBankName" runat="server" Text=""></asp:Label>)</dd>
                    <dt>TK Khách</dt>
                    <dd>
                    ...
                    <dt>Nội dung CK</dt>
                    <dd>
                        <asp:Label ID="lblNote" runat="server" Text=""></asp:Label></dd>
                    <dt>Create Time</dt>
                    <dd>
                    ...
                    <dt>Description</dt>
                    <dd>
                        <asp:Label ID="lblDescription" runat="server" Text=""></asp:Label></dd>
                </dl>
                ...
                <div class="col-xs-12">
                    <button type="button" class="btn btn-primary pull-right" style="margin-right: 5px;" runat="server" id="btnCheckTran" onserverclick="btnCheckTran_Click">
                        <i class="fa fa-check-square-o"></i> Gọi Bank Client kiểm tra
                    </button>
