<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="Edit.TranIn.aspx.cs" Inherits="Pages_Monitor_Edit_TranIn" %>
    ...
    <section class="content">
        <div class="box box-solid">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">
                    <asp:Label ID="lblTtitle" runat="server" Text="Chỉnh sửa nội dung giao dịch" CssClass="title"></asp:Label></h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
                <dl class="dl-horizontal">
                    ...
                    <dt>Tk Dịch Vụ</dt>
                    <dd>
                        <asp:Label ID="lblPartnerMomoId" runat="server"></asp:Label></dd>
                    <dt>TK Khách</dt>
                    <dd>
                        <asp:Label ID="lblUserMomoId" runat="server"></asp:Label></dd>
                    <dt>Amount</dt>
                    <dd>
                        <asp:Label ID="lblAmount" runat="server" Text=""></asp:Label></dd>
                    <dt>Nội dung CK</dt>
                    <dd>
                        <asp:TextBox ID="txtNote" runat="server" class="form-control" placeholder="Nhập nội dung..." Text=""></asp:TextBox></dd>
                    <dt>Create Time</dt>
                    <dd>
                        <asp:Label ID="lblCreatTime" runat="server" Text=""></asp:Label></dd>
                    <dt>Momo Time Success</dt>
                    <dd>
                        <asp:Label ID="lblMomoTime" runat="server" Text=""></asp:Label></dd>
                ...
                <div class="col-xs-12">
                    <button type="button" class="btn btn-primary pull-right" style="margin-right: 5px;" runat="server" id="btnCheckTran" onserverclick="btnEditTran_Click">
