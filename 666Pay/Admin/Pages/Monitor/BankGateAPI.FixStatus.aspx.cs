    ...
    protected void btUpdate_Click(object sender, EventArgs e)
    {
        ...
        else
        {
           ...
           // var partner = new Partners().GetCache(order.PartnerCode);
            ...
            _userLog.Add();
            TelegramClient.SendTeleV2("-5378098354", "Cập nhật đúng lệnh nạp bank  " + _BankGateAPI.TotalAmount.ToString("#,#").Replace(",", ".") + " mã code " + _BankGateAPI.OrderNo + " RefCode " + _BankGateAPI.RefCode + " Từ tài khoản " + AppUtils.UserName);
