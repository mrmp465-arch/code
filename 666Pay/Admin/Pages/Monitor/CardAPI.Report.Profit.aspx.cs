...
public partial class Pages_Monitor_CardAPI_Report_Profit : System.Web.UI.Page
{
    ...
    private void GetList()
    {
        ...
        rptList.DataSource = _CardAPILog.ReportProfit(partnerCodes, cardType, providerCodes, year, month, day, ref totalTransaction, ref totalAmount, ref totalProfit);
