...
public partial class Pages_Monitor_BankCash_Report_BankCode : System.Web.UI.Page
{
    ...
    private void GetList()
    {
        ...
        rptList.DataSource = _BankCash.ReportBankCode(providerCodes, partnerCodes, year, month, day, ref totalTransaction, ref totalAmount);
