...
public partial class Pages_Monitor_BankCash_Report_Service : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        AppUtils.CheckRoles(Resources.Url.BankCashReportService);
    ...
    private void GetList()
    {
        ...
        rptList.DataSource = _BankCash.ReportService(bankCode, providerCodes, year, month, day, ref totalTransaction, ref totalAmount);
    ...
    {
        Response.Redirect(Constant.ADMIN_PATH + Resources.Url.BankCashReport);
    }
