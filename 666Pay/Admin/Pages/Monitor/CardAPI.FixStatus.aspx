<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="CardAPI.FixStatus.aspx.cs" Inherits="Pages_Monitor_CardAPI_FixStatus" %>
    ...
    <section class="content"> 
        <div class="nav-tabs-custom"> 
            <ul class="nav nav-tabs pull-left">
                ...
                <li class="active"><a href="#revenue-chart" data-toggle="tab">Sửa theo TransId</a></li>
                <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.CardAPIFixBulk %>">Sửa theo Bulk</a></li>
            </ul>
