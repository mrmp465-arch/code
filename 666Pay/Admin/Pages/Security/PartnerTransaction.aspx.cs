...
public partial class Pages_Security_PartnerTransaction : System.Web.UI.Page
{
    ...
    protected void btAdd_Click(object sender, EventArgs e)
    {
        ...
        TelegramClient.SendTeleV2("-5569640045", "Tạo lệnh rút tiền  " + amount.ToString("#,#").Replace(",", ".") + " từ user " + AppUtils.UserName + " Mã lệnh " + result.ToString());
    ...
    protected void Delete_Command(Object sender, CommandEventArgs e)
    {
        ...
        if (_tran.Status == 0)
        {
            ...
            TelegramClient.SendTeleV2("-5569640045", "Hủy lệnh rút tiền từ user " + AppUtils.UserName + " Mã lệnh " + _tran.Id.ToString() + ", Số tiền " + _tran.Amount.ToString("#,#").Replace(",", "."));
            //GetList();
    ...
    protected void Update_Command(Object sender, CommandEventArgs e)
    {
        ...
        _tran.Confirm();
        _tran = _tran.Get();
        TelegramClient.SendTeleV2("-5569640045", "Duyệt lệnh rút tiền từ user " + AppUtils.UserName + " Mã lệnh " + _tran.Id.ToString() + ", Số tiền " + _tran.Amount.ToString("#,#").Replace(",", "."));
        //GetList();
        Response.Redirect(Request.RawUrl);
