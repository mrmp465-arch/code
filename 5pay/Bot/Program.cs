    ...
    class Program
    {
                        ...
                        if (!string.IsNullOrEmpty(bank.AppDeviceId))
                        {
                           ...
                           // NLogLogger.Info(key);
                            ...
                            if (result == null)
                            {
                                ...
                                SendTeleV3("-4830767963", "[OTP] Tài khoản VPB:  " + bank.BankName + " phone " + bank.PhoneDevice + " không có OTP => Ae tắt app đi bật lại. pin OTP " + bank.PinOtp);
                            }
                        }
        ...
        public static void SendTeleV3(string id, string message)
        {
            try
            {
                ...
                var requestUrl = string.Format("https://api.telegram.org/bot8010825769:AAEbExMZtB9twOsAb8uyjM6noeWfWlPm5yg/sendMessage?chat_id={1}&parse_mode=html&text={0}", message, id);
