...
public partial class Pages_BankEWalletService_Bank_Transaction : System.Web.UI.Page
{
    ...
    private void GetList()
    {
        ...
        {
            NLogLogger.Info("BankTransaciton GetList"+ ex.Message);
    ...
    protected void ExportTran2_Click(object sender, EventArgs e)
    {
        ...
        var data = new BankTransaction().GetList(50000, id, drpPartner.SelectedValue, txtPartnerBankId.Text, txBankTransId.Text, drpPartnerBankCode.SelectedValue, txtBankId.Text, drpType.SelectedValue, creatTime, status, amount, minamount, maxamount, txtRefCode.Text, txtComment.Text, cbComentNull.Checked, fromDate);
