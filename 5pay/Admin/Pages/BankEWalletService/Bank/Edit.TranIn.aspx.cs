...
public partial class Pages_BankEWalletService_Bank_Edit_TranIn : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        if (!_bankTranLog.Comment.Contains("vo_hieu"))
        {
    ...
    protected void btnEditTran_Click(object sender, EventArgs e)
    {
        ...
        if (txtNote.Text.Contains("huybo"))
        {
            ...
            //TelegramClient.SendTeleV2("-1003968792146", "Cập nhật nội dung giao dịch bank " + _bankTranLog.Id + " | " + _bankTranLog.Comment + " | " + _bankTranLog.Amount.GetValueOrDefault().ToString("#,#").Replace(",", ".") + " Từ tài khoản " + AppUtils.UserName);
