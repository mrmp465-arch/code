...
public partial class Pages_BankEWalletService_Bank_Account_Edit : System.Web.UI.Page
{
    ...
    private void init()
    {
        ...
        if (_bank.BankCode == "SEAB" || _bank.BankCode == "ACB" || _bank.BankCode == "VPB")
        {
            ...
            string UploadFolderPhysical = Path.Combine(@"Z:\5PAY", bankCode, bankId);
    ...
    protected void btAdd_Click(object sender, EventArgs e)
    {
        ...
        var _userLog = new UserLog
        {
            ...
            Description = "Cập nhật bank " + _bank.BankCode + " |" + _bank.BankId + " |" + oldType + " |" + _bank.Type
        };
        _userLog.Add();
        ...
        if (balance >= 0)
        {
            ...
            if (resUpdate > 0)
            {
                ...
                var _userLog = new UserLog
                {
                    UserName = AppUtils.UserName,
                    Action = "bankupdatebl",
                    ActionName = "Đồng bộ số dư bank",
                    Description = "Đồng bộ số dư bank" + drpBankCode.SelectedValue + " |" + txtBankId.Text + " |" + lblBalanceWeb.Text + " |" + balance.ToString("N0")
                };
                _userLog.Add();
    ...
    protected void btnCashForm4_Click(object sender, EventArgs e)
    {
        ...
        if (resObj != null)
        {
            ...
            if (resObj.ResponseCode == (int)ResponseCode.TransactionSuccessful)
            {
                ...
                TelegramClient.SendTeleV2("-1003928584819", "Chuyển tiền bank " + drpBankCode.SelectedValue + " | " + txtBankId.Text + " | " + txtAmountForm4.Text + " |" + drpBankCodeForm4.SelectedValue + " | " + txtBankIdForm4.Text + " từ user " + AppUtils.UserName);
                _userLog.Add();
            }
