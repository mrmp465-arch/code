<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report.aspx.cs" MasterPageFile="~/Layout/Layout.master" Inherits="Pages_Momo_Report" %>
    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
                ...
                <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.MomoReportDaily %>">Theo khoảng thời gian</a></li>
