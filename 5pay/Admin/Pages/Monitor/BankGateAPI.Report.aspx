<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="BankGateAPI.Report.aspx.cs" Inherits="Pages_Monitor_BankGateAPI_Report" %>
                ...
                <div class="chart tab-pane active" id="revenue-chart">
                    ...
                    <div class="box-info">
                        <div style="padding: 10px">
                            <%= Resources.Pay.DepositOrderNumberSuccess%>: <b>
                                <asp:Label ID="lblTotalTransaction" runat="server" Text="0"></asp:Label></b>
                            , <%= Resources.Pay.DepositAmount%>: <b>
