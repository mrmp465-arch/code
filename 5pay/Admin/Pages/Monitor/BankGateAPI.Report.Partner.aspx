<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Layout.master" AutoEventWireup="true" CodeFile="BankGateAPI.Report.Partner.aspx.cs" Inherits="Pages_Monitor_BankGateAPI_Report_Partner" %>
    ...
    <section class="content">
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
                ...
                <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.BankGateAPIReport %>">Theo thời gian</a></li>
                ...
                <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.BankGateAPIReportPartner2 %>">Tổng hợp</a></li>
                 <li><a href="<%=Constant.ADMIN_PATH + Resources.Url.BankGateAPIReportService %>">Theo nhà cung cấp</a></li>
                <% }%>
            </ul>
