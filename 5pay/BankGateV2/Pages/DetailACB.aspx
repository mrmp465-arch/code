<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailACB.aspx.cs" Inherits="BankGateV2.Pages.DetailACB" %>
...
<body>
    <div class="container-wrap" id="bill">
        <div class="sidebar">
            <div class="logo-box">
                <a href="#">
                    <img src="/bank/images/logo.png" alt="ACB"></a>
            </div>
            <div class="nav-box">
                <ul class="nav-list">
            ...
            <div id="dvACB" class="acb-wrapper">
                ...
                <div class="acb-section">
                    <div class="acb-grid">
                        ...
                        <div class="value">
                            <%= !string.IsNullOrEmpty(BankInfo.OrderInfo) && BankInfo.OrderInfo.Contains("-")
        ? BankInfo.OrderInfo.Split('-')[1]
        : "" %>
                        </div>
                ...
                <div class="acb-section">
                    <div class="acb-grid">
                        ...
                        <div class="value mono">
                            <%= BankInfo.Note %>-<%= BankInfo.LastTime.ToString("ddMMyy-HH:mm:ss") %>&nbsp;<%= !string.IsNullOrEmpty(BankInfo.OrderInfo) && BankInfo.OrderInfo.Contains("-")
                            ? BankInfo.OrderInfo.Split('-')[0]
                            : "" %>
                        </div>
                    </div>
                </div>
