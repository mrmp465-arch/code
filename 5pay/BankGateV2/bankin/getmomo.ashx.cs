...
namespace BankGateV2.bankin
{
    ...
    /// </summary>
    public class getmomo : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                var request = javaScriptSerializer.Deserialize<RequestGetMomo>(jsonString);
                //NLogLogger.Info(new string[] { "VPGJsonService", "Request", jsonString });
                result = VPGUtils.RequestGetMomo(request.PartnerCode, "momov2", request.Signature,request.RequestTime);
            }
            catch (Exception exp)
            {
