...
namespace WService
{
    partial class UnlockSimProcess : ServiceBase
    {
        private UnlockSimService unlockSimService = new UnlockSimService();

        public UnlockSimProcess()
        {
            InitializeComponent();

            unlockSimService.StartProcessUnlockSim();
        }
